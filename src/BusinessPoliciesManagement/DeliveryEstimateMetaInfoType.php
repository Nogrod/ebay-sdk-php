...
class DeliveryEstimateMetaInfoType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\BusinessPoliciesManagement\DeliveryEstimateMetaInfoType
    {
        $self = new self();
    ...
    {
        $value = Func::mapValue($keyValue, '{http://www.ebay.com/marketplace/selling/v1/services}key');
        if (null !== $value) {
            $this->setKey($value);
        }
