...
class ErrorDataType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  <dl>
     *  <lh><b>Subdomains include</b>:</lh>
     *  <dt>
     *  <b>BulkDataExchangeService</b>
     *  </dt>
     *  <dd>
     *  The error is specific to the Bulk Data Exchange API.
     *  </dd>
     *  <dt>
     *  <b>MarketplaceCommon</b>
     *  </dt>
     *  <dd>
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\BulkDataExchange\ErrorParameterType $parameter
     */
    public function addToParameter(\Nogrod\eBaySDK\BulkDataExchange\ErrorParameterType $parameter)
    {
     ...
     *  triggered the error.
     *
     * @return \Nogrod\eBaySDK\BulkDataExchange\ErrorParameterType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setParameter(array_map(function ($v) {
                return \Nogrod\eBaySDK\BulkDataExchange\ErrorParameterType::fromKeyValue($v);
            }, $value));
        }
    }
}
