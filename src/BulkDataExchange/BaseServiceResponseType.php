...
class BaseServiceResponseType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\BulkDataExchange\ErrorDataType[] $errorMessage
     */
     ...
     */
    public function addToErrorMessage(\Nogrod\eBaySDK\BulkDataExchange\ErrorDataType $error)
    {
     ...
     *  request. Not returned if the ack value is Success.
     *
     * @param \Nogrod\eBaySDK\BulkDataExchange\ErrorDataType[] $errorMessage
     * @return self
     */
