...
class SellerProfilePreferencesType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\SupportedSellerProfileType[] $supportedSellerProfiles
     */
     ...
     */
    public function addToSupportedSellerProfiles(\Nogrod\eBaySDK\MerchantData\SupportedSellerProfileType $supportedSellerProfile)
    {
     ...
     *  and the seller has one or more Business Policies profiles active on the account.
     *
     * @param \Nogrod\eBaySDK\MerchantData\SupportedSellerProfileType[] $supportedSellerProfiles
     * @return self
     */
