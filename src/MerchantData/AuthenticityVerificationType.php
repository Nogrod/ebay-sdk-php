...
class AuthenticityVerificationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ServiceCostType $serviceCost
     */
     ...
     * This container shows service cost to the buyer for an item that will go through the Authenticity Guarantee process.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ServiceCostType
     */
     ...
     * This container shows service cost to the buyer for an item that will go through the Authenticity Guarantee process.
     *
     * @param \Nogrod\eBaySDK\MerchantData\ServiceCostType $serviceCost
     * @return self
     */
    public function setServiceCost(\Nogrod\eBaySDK\MerchantData\ServiceCostType $serviceCost)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setServiceCost(\Nogrod\eBaySDK\MerchantData\ServiceCostType::fromKeyValue($value));
        }
    }
}
