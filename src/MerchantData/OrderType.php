...
class OrderType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $amountSaved
     */
     ...
     *  <br>
     *  <br>
     *  <span class="tablenote"><b>Note:</b> For sellers opted in to the new eBay Managed Payments program, the enumeration value returned in this field will be <code>CreditCard</code>, regardless of which payment method that the buyer used (or is planning to use). <br><br>Similarly, for an <b>AddOrder</b> call, a seller opted in to eBay Managed Payments should only pass a value of <code>CreditCard</code> into this field.<br><br> eBay Managed Payments is currently only available to a limited number of sellers on the US site. For sellers in the eBay Managed Payments program, a payment method does not need to be specified at listing/checkout time.
     *  </span><br>
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $subtotal
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\TransactionType[] $transactionArray
     */
     ...
     *  <br/><br/>
     *  This container is only returned if the order has one or more order line items that require shipping through GSP. It is not returned if <strong>IsMultilegShipping</strong> is <code>false</code>.
     *
     ...
     * This value indicates the amount that the buyer saved on the order due to any discounts (item, shipping, promotional) applied to the purchase, or if the seller 'manually' reduced the order total. This field is always returned even when it is '0.0'.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $amountSaved
     * @return self
     */
    public function setAmountSaved(\Nogrod\eBaySDK\MerchantData\AmountType $amountSaved)
    {
     ...
     * The cumulative item cost for all line items in the order. This value does not take into account any shipping/handling costs, sales tax costs, or any discounts. For a single line item order, the amount in this field should be the same as the amount in the <strong>Transaction.TransactionPrice</strong> field. For a multiple line item order, the amount in this field should equal the cumulative amount of each <strong>Transaction.TransactionPrice</strong> fields for each order line item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $subtotal
     * @return self
     */
    public function setSubtotal(\Nogrod\eBaySDK\MerchantData\AmountType $subtotal)
    {
     ...
     * @return self
     */
    public function setTotal(\Nogrod\eBaySDK\MerchantData\AmountType $total)
    {
        $this->total = $total;
        return $this;
    }
     ...
     */
    public function addToTransactionArray(\Nogrod\eBaySDK\MerchantData\TransactionType $transaction)
    {
     ...
     *  Under the <b>TransactionArray</b> container in an <b>AddOrder</b> call, a seller or buyer specifies two or more (up to 40) order line items into a 'Combined Invoice' order.
     *
     * @param \Nogrod\eBaySDK\MerchantData\TransactionType[] $transactionArray
     * @return self
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\CancelDetailType $cancelDetail
     */
    public function addToCancelDetail(\Nogrod\eBaySDK\MerchantData\CancelDetailType $cancelDetail)
    {
     ...
     * This container consists of details related to an eBay order that has been cancelled or is in the process of possibly being cancelled. Order cancellation requests can be viewed and managed with the cancellation API calls that are available in the <a href="https://developer.ebay.com/Devzone/post-order/index.html#CallIndex">Post Order API</a>.
     *
     * @return \Nogrod\eBaySDK\MerchantData\CancelDetailType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AmountSaved');
        if (null !== $value) {
            $this->setAmountSaved(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CreatingUserRole');
        if (null !== $value) {
            $this->setCreatingUserRole($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CreatedTime');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerEmail');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Subtotal');
        if (null !== $value) {
            $this->setSubtotal(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Total');
        if (null !== $value) {
            $this->setTotal(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TransactionArray', true);
        if (null !== $value && !empty($value)) {
            $this->setTransactionArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\TransactionType::fromKeyValue($v);
            }, $value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerEIASToken');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CancelDetail', true);
        if (null !== $value && !empty($value)) {
            $this->setCancelDetail(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\CancelDetailType::fromKeyValue($v);
            }, $value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BuyerTaxIdentifier', true);
        if (null !== $value && !empty($value)) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ContainseBayPlusTransaction');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}OrderLineItemCount');
        if (null !== $value) {
