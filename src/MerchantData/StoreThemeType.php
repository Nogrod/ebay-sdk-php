...
class StoreThemeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * @return self
     */
    public function setColorScheme(\Nogrod\eBaySDK\MerchantData\StoreColorSchemeType $colorScheme)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ColorScheme');
        if (null !== $value) {
            $this->setColorScheme(\Nogrod\eBaySDK\MerchantData\StoreColorSchemeType::fromKeyValue($value));
        }
    }
