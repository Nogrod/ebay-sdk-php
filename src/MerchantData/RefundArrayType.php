...
class RefundArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundType[] $refund
     */
    private $refund = [
     ...
     */
    public function addToRefund(\Nogrod\eBaySDK\MerchantData\RefundType $refund)
    {
        $this->refund[] = $refund;
        return $this;
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefund(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundType::fromKeyValue($v);}, $value));
        }
    }
}
