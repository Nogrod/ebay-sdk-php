...
class StoreSubscriptionArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\StoreSubscriptionType $subscription
     */
    public function addToSubscription(\Nogrod\eBaySDK\MerchantData\StoreSubscriptionType $subscription)
    {
     ...
     * A Store subscription level.
     *
     * @return \Nogrod\eBaySDK\MerchantData\StoreSubscriptionType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Subscription', true);
