...
class BestOfferDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $bestOffer
     */
     ...
     * This is the amount of the buyer's current Best Offer. This field will not appear in the <b>GetMyeBayBuying</b> response if the buyer has not made a Best Offer. This field is also not applicable to the <b>Add</b>/<b>Revise</b>/<b>Relist</b> calls.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $bestOffer
     * @return self
     */
    public function setBestOffer(\Nogrod\eBaySDK\MerchantData\AmountType $bestOffer)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BestOffer');
        if (null !== $value) {
            $this->setBestOffer(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BestOfferStatus');
        if (null !== $value) {
            $this->setBestOfferStatus($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BestOfferType');
        if (null !== $value) {
