...
class PromotionalSaleDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  Display feature.
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $originalPrice
     */
     ...
     *  Display feature.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $originalPrice
     * @return self
     */
    public function setOriginalPrice(\Nogrod\eBaySDK\MerchantData\AmountType $originalPrice)
    {
    ...
    {
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}OriginalPrice');
        if (null !== $value) {
            $this->setOriginalPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
