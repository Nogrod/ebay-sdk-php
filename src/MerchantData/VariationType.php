...
class VariationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\VariationProductListingDetailsType $variationProductListingDetails
     */
     ...
     *  product identifier and you cannot remove existing product variation listing details data.
     *
     * @return \Nogrod\eBaySDK\MerchantData\VariationProductListingDetailsType
     */
     ...
     *  product identifier and you cannot remove existing product variation listing details data.
     *
     * @param \Nogrod\eBaySDK\MerchantData\VariationProductListingDetailsType $variationProductListingDetails
     * @return self
     */
    public function setVariationProductListingDetails(\Nogrod\eBaySDK\MerchantData\VariationProductListingDetailsType $variationProductListingDetails)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}UnitsAvailable');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}VariationTitle');
        if (null !== $value) {
            $this->setVariationTitle($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}VariationViewItemURL');
        if (null !== $value) {
            $this->setVariationViewItemURL($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Delete');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}VariationProductListingDetails');
        if (null !== $value) {
