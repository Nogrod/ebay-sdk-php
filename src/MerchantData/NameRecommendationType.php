...
class NameRecommendationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\RelevanceIndicatorType $relevanceIndicator
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ValueRecommendationType[] $valueRecommendation
     */
     ...
     *  </span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\RelevanceIndicatorType
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\RelevanceIndicatorType $relevanceIndicator
     * @return self
     */
    public function setRelevanceIndicator(\Nogrod\eBaySDK\MerchantData\RelevanceIndicatorType $relevanceIndicator)
    {
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ValueRecommendationType $valueRecommendation
     */
    public function addToValueRecommendation(\Nogrod\eBaySDK\MerchantData\ValueRecommendationType $valueRecommendation)
    {
     ...
     *  In addition to the recommended value(s) for an Item Specific, a <b>ValueRecommendation.ValidationRules</b> container will be returned if the <b>IncludeConfidence</b> filter is included in the call request and set to <code>true</code>. The return 'Confidence' value is a percentage value that indicates how confident eBay is that the recommended value is a valid value for the corresponding Item Specific. The <b>ValueRecommendation.ValidationRules</b> container may also get returned for the 'Brand' Item Specific if the particular product brand in that listing category requires an association with an eBay catalog product.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ValueRecommendationType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setRelevanceIndicator(\Nogrod\eBaySDK\MerchantData\RelevanceIndicatorType::fromKeyValue($value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setValueRecommendation(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ValueRecommendationType::fromKeyValue($v);
            }, $value));
        }
