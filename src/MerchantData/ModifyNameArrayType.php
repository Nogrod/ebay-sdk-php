...
class ModifyNameArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ModifyNameType[] $modifyName
     */
    private $modifyName = [
     ...
     */
    public function addToModifyName(\Nogrod\eBaySDK\MerchantData\ModifyNameType $modifyName)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ModifyName', true);
        if (null !== $value && !empty($value)) {
            $this->setModifyName(array_map(function ($v) {
