...
class PromotedItemType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    /**
     * @var \Nogrod\eBaySDK\MerchantData\PromotionDetailsType[] $promotionDetails
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PromotionDetailsType $promotionDetails
     */
    public function addToPromotionDetails(\Nogrod\eBaySDK\MerchantData\PromotionDetailsType $promotionDetails)
    {
     ...
     *
     * @return \Nogrod\eBaySDK\MerchantData\PromotionDetailsType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PictureURL');
        if (null !== $value) {
            $this->setPictureURL($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Position');
        if (null !== $value) {
            $this->setPosition($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SelectionType');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PromotionDetails', true);
        if (null !== $value && !empty($value)) {
            $this->setPromotionDetails(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\PromotionDetailsType::fromKeyValue($v);
            }, $value));
        }
