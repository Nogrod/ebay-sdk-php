...
class MyeBayFavoriteSellerListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerType[] $favoriteSeller
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerType $favoriteSeller
     */
    public function addToFavoriteSeller(\Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerType $favoriteSeller)
    {
     ...
     * A favorite seller the user has saved, with a user ID and store name.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteSeller', true);
        if (null !== $value && !empty($value)) {
            $this->setFavoriteSeller(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerType::fromKeyValue($v);
            }, $value));
        }
    }
