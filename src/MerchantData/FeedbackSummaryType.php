...
class FeedbackSummaryType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setBidRetractionFeedbackPeriodArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NegativeFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setNegativeFeedbackPeriodArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NeutralFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setNeutralFeedbackPeriodArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PositiveFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setPositiveFeedbackPeriodArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TotalFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setTotalFeedbackPeriodArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setSellerRatingSummaryArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\AverageRatingSummaryType::fromKeyValue($v);}, $value));
        }
