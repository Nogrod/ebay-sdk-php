...
class FeedbackSummaryType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $bidRetractionFeedbackPeriodArray
     */
     ...
     *  the call. Returned if no detail level is specified.
     *
     * @var \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $negativeFeedbackPeriodArray
     */
     ...
     *  the call. Returned if no detail level is specified.
     *
     * @var \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $neutralFeedbackPeriodArray
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $positiveFeedbackPeriodArray
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $totalFeedbackPeriodArray
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AverageRatingSummaryType[] $sellerRatingSummaryArray
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\SellerRoleMetricsType $sellerRoleMetrics
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\BuyerRoleMetricsType $buyerRoleMetrics
     */
     ...
     */
    public function addToBidRetractionFeedbackPeriodArray(\Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod)
    {
     ...
     *  the call. Returned if no detail level is specified.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $bidRetractionFeedbackPeriodArray
     * @return self
     */
     ...
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod
     */
    public function addToNegativeFeedbackPeriodArray(\Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod)
    {
     ...
     *  the call. Returned if no detail level is specified.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $negativeFeedbackPeriodArray
     * @return self
     */
     ...
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod
     */
    public function addToNeutralFeedbackPeriodArray(\Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod)
    {
     ...
     *  the call. Returned if no detail level is specified.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $neutralFeedbackPeriodArray
     * @return self
     */
     ...
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod
     */
    public function addToPositiveFeedbackPeriodArray(\Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod)
    {
     ...
     *  preceding the call. Returned if no detail level is specified.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $positiveFeedbackPeriodArray
     * @return self
     */
     ...
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod
     */
    public function addToTotalFeedbackPeriodArray(\Nogrod\eBaySDK\MerchantData\FeedbackPeriodType $feedbackPeriod)
    {
     ...
     *  call. Returned if no detail level is specified.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType[] $totalFeedbackPeriodArray
     * @return self
     */
     ...
     */
    public function addToSellerRatingSummaryArray(\Nogrod\eBaySDK\MerchantData\AverageRatingSummaryType $averageRatingSummary)
    {
     ...
     *  API-enabled country sites, including the US site (site ID 0).
     *
     * @param \Nogrod\eBaySDK\MerchantData\AverageRatingSummaryType[] $sellerRatingSummaryArray
     * @return self
     */
     ...
     * Container for information about 1 year feedback metric as seller.
     *
     * @return \Nogrod\eBaySDK\MerchantData\SellerRoleMetricsType
     */
     ...
     * Container for information about 1 year feedback metric as seller.
     *
     * @param \Nogrod\eBaySDK\MerchantData\SellerRoleMetricsType $sellerRoleMetrics
     * @return self
     */
    public function setSellerRoleMetrics(\Nogrod\eBaySDK\MerchantData\SellerRoleMetricsType $sellerRoleMetrics)
    {
     ...
     * Container for information about 1 year feedback metric as buyer.
     *
     * @return \Nogrod\eBaySDK\MerchantData\BuyerRoleMetricsType
     */
     ...
     * Container for information about 1 year feedback metric as buyer.
     *
     * @param \Nogrod\eBaySDK\MerchantData\BuyerRoleMetricsType $buyerRoleMetrics
     * @return self
     */
    public function setBuyerRoleMetrics(\Nogrod\eBaySDK\MerchantData\BuyerRoleMetricsType $buyerRoleMetrics)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BidRetractionFeedbackPeriodArray', true);
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NegativeFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setNegativeFeedbackPeriodArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NeutralFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setNeutralFeedbackPeriodArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PositiveFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setPositiveFeedbackPeriodArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TotalFeedbackPeriodArray', true);
        if (null !== $value && !empty($value)) {
            $this->setTotalFeedbackPeriodArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\FeedbackPeriodType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NeutralCommentCountFromSuspendedUsers');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerRatingSummaryArray', true);
        if (null !== $value && !empty($value)) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerRoleMetrics');
        if (null !== $value) {
            $this->setSellerRoleMetrics(\Nogrod\eBaySDK\MerchantData\SellerRoleMetricsType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BuyerRoleMetrics');
        if (null !== $value) {
            $this->setBuyerRoleMetrics(\Nogrod\eBaySDK\MerchantData\BuyerRoleMetricsType::fromKeyValue($value));
        }
    }
