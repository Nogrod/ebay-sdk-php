...
class ItemBestOffersArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ItemBestOffersType[] $itemBestOffers
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ItemBestOffersType $itemBestOffers
     */
    public function addToItemBestOffers(\Nogrod\eBaySDK\MerchantData\ItemBestOffersType $itemBestOffers)
    {
     ...
     * A collection of details about the Best Offers received for a specific item. Empty if there are no Best Offers. Includes the buyer and seller messages only if the <code>ReturnAll</code> detail level is used.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ItemBestOffersType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ItemBestOffers', true);
        if (null !== $value && !empty($value)) {
            $this->setItemBestOffers(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ItemBestOffersType::fromKeyValue($v);
            }, $value));
        }
    }
