...
class RecommendationValidationRulesType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\NameValueRelationshipType[] $relationship
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\NameValueRelationshipType $relationship
     */
    public function addToRelationship(\Nogrod\eBaySDK\MerchantData\NameValueRelationshipType $relationship)
    {
     ...
     *  number you specified in <b>MaxValuesPerName</b>).
     *
     * @return \Nogrod\eBaySDK\MerchantData\NameValueRelationshipType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRelationship(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\NameValueRelationshipType::fromKeyValue($v);
            }, $value));
        }
