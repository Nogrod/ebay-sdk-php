...
class UploadSiteHostedPicturesResponseType extends AbstractResponseType
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\SiteHostedPictureDetailsType $siteHostedPictureDetails
     */
     ...
     * The information about an <b>UploadSiteHostedPictures</b> upload, including the URL of the uploaded picture.
     *
     * @return \Nogrod\eBaySDK\MerchantData\SiteHostedPictureDetailsType
     */
     ...
     * The information about an <b>UploadSiteHostedPictures</b> upload, including the URL of the uploaded picture.
     *
     * @param \Nogrod\eBaySDK\MerchantData\SiteHostedPictureDetailsType $siteHostedPictureDetails
     * @return self
     */
    public function setSiteHostedPictureDetails(\Nogrod\eBaySDK\MerchantData\SiteHostedPictureDetailsType $siteHostedPictureDetails)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SiteHostedPictureDetails');
        if (null !== $value) {
            $this->setSiteHostedPictureDetails(\Nogrod\eBaySDK\MerchantData\SiteHostedPictureDetailsType::fromKeyValue($value));
        }
    }
