...
class DiscountDetailType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     */
    public function addToDiscount(\Nogrod\eBaySDK\MerchantData\DiscountType $discount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setDiscount(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\DiscountType::fromKeyValue($v);}, $value));
        }
    }
}
