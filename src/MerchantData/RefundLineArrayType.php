...
class RefundLineArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundLineType[] $refundLine
     */
    private $refundLine = [
     ...
     */
    public function addToRefundLine(\Nogrod\eBaySDK\MerchantData\RefundLineType $refundLine)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundLine', true);
