...
class SellingManagerSoldTransactionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * Price per item.
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $itemPrice
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $subtotalAmount
     */
     ...
     * Price per item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $itemPrice
     * @return self
     */
    public function setItemPrice(\Nogrod\eBaySDK\MerchantData\AmountType $itemPrice)
    {
     ...
     *  <b>QuantitySold</b> value.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $subtotalAmount
     * @return self
     */
    public function setSubtotalAmount(\Nogrod\eBaySDK\MerchantData\AmountType $subtotalAmount)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}InvoiceNumber');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SubtotalAmount');
        if (null !== $value) {
            $this->setSubtotalAmount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SecondChanceOfferSent');
        if (null !== $value) {
            $this->setSecondChanceOfferSent($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CustomLabel');
        if (null !== $value) {
            $this->setCustomLabel($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SoldOn');
        if (null !== $value) {
            $this->setSoldOn($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ListedOn', true);
        if (null !== $value && !empty($value)) {
            $this->setListedOn($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Shipment');
        if (null !== $value) {
            $this->setShipment(\Nogrod\eBaySDK\MerchantData\ShipmentType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CharityListing');
        if (null !== $value) {
