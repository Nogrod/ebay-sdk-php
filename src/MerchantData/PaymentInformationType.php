...
class PaymentInformationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     */
    public function addToPayment(\Nogrod\eBaySDK\MerchantData\PaymentTransactionType $payment)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setPayment(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\PaymentTransactionType::fromKeyValue($v);}, $value));
        }
    }
}
