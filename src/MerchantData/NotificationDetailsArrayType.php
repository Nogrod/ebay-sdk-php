...
class NotificationDetailsArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\NotificationDetailsType[] $notificationDetails
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\NotificationDetailsType $notificationDetails
     */
    public function addToNotificationDetails(\Nogrod\eBaySDK\MerchantData\NotificationDetailsType $notificationDetails)
    {
     ...
     * Each <b>NotificationDetails</b> container consists of detailed information about one notification. <b>NotificationDetails</b> container(s) are only returned if an <b>ItemID</b> value was specified in the request, and there were one or more notifications related to this listing during the specified time range.
     *
     * @return \Nogrod\eBaySDK\MerchantData\NotificationDetailsType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NotificationDetails', true);
        if (null !== $value && !empty($value)) {
            $this->setNotificationDetails(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\NotificationDetailsType::fromKeyValue($v);
            }, $value));
        }
    }
