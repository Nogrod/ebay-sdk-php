...
class CharityType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  details. </li>
     *  </ul>
     *  The <b>DonationPercent</b> is required in an Add/Revise/Relist call if the seller will be donating a percentage of the sale proceeds for each sale generated by the listing.
     *
    ...
    /**
     * The URL of the nonprofit charity organization's logo.
     *
     * @var string $logoURL
     */
