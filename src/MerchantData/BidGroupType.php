...
class BidGroupType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\BidGroupItemType $bidGroupItem
     */
    public function addToBidGroupItem(\Nogrod\eBaySDK\MerchantData\BidGroupItemType $bidGroupItem)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\BidGroupItemType[]
     */
