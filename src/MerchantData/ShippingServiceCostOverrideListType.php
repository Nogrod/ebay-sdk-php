...
class ShippingServiceCostOverrideListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     */
    public function addToShippingServiceCostOverride(\Nogrod\eBaySDK\MerchantData\ShippingServiceCostOverrideType $shippingServiceCostOverride)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setShippingServiceCostOverride(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\ShippingServiceCostOverrideType::fromKeyValue($v);}, $value));
        }
    }
}
