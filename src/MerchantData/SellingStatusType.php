...
class SellingStatusType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  listings.
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $bidIncrement
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $convertedCurrentPrice
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $currentPrice
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\UserType $highBidder
     */
     ...
     *  variation that is still available for sale.
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $minimumToBid
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\PromotionalSaleDetailsType $promotionalSaleDetails
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType[] $suggestedBidValues
     */
     ...
     *  listings.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $bidIncrement
     * @return self
     */
    public function setBidIncrement(\Nogrod\eBaySDK\MerchantData\AmountType $bidIncrement)
    {
     ...
     *  variation that is still available for sale.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $convertedCurrentPrice
     * @return self
     */
    public function setConvertedCurrentPrice(\Nogrod\eBaySDK\MerchantData\AmountType $convertedCurrentPrice)
    {
     ...
     *  In multi-variation, fixed-price listings, this value matches the lowest-priced variation that is still available for sale.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $currentPrice
     * @return self
     */
    public function setCurrentPrice(\Nogrod\eBaySDK\MerchantData\AmountType $currentPrice)
    {
     ...
     *  (or only for the first order line item that is created).
     *
     * @param \Nogrod\eBaySDK\MerchantData\UserType $highBidder
     * @return self
     */
    public function setHighBidder(\Nogrod\eBaySDK\MerchantData\UserType $highBidder)
    {
     ...
     *  variation that is still available for sale.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $minimumToBid
     * @return self
     */
    public function setMinimumToBid(\Nogrod\eBaySDK\MerchantData\AmountType $minimumToBid)
    {
     ...
     *  and end-time of the discount.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PromotionalSaleDetailsType
     */
     ...
     *  and end-time of the discount.
     *
     * @param \Nogrod\eBaySDK\MerchantData\PromotionalSaleDetailsType $promotionalSaleDetails
     * @return self
     */
    public function setPromotionalSaleDetails(\Nogrod\eBaySDK\MerchantData\PromotionalSaleDetailsType $promotionalSaleDetails)
    {
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $bidValue
     */
    public function addToSuggestedBidValues(\Nogrod\eBaySDK\MerchantData\AmountType $bidValue)
    {
     ...
     *  The <b>SuggestedBidValues</b> container consists of an array of incremental bid values (up to the dollar value in the <b>Offer.MaxBid</b> field) that eBay will bid on behalf of the buyer each time that buyer is outbid for the auction item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType[] $suggestedBidValues
     * @return self
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BidIncrement');
        if (null !== $value) {
            $this->setBidIncrement(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ConvertedCurrentPrice');
        if (null !== $value) {
            $this->setConvertedCurrentPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CurrentPrice');
        if (null !== $value) {
            $this->setCurrentPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}HighBidder');
        if (null !== $value) {
            $this->setHighBidder(\Nogrod\eBaySDK\MerchantData\UserType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}LeadCount');
        if (null !== $value) {
            $this->setLeadCount($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MinimumToBid');
        if (null !== $value) {
            $this->setMinimumToBid(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}QuantitySold');
        if (null !== $value) {
            $this->setQuantitySold($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ReserveMet');
        if (null !== $value) {
            $this->setReserveMet($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SecondChanceEligible');
        if (null !== $value) {
            $this->setSecondChanceEligible($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BidderCount');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PromotionalSaleDetails');
        if (null !== $value) {
            $this->setPromotionalSaleDetails(\Nogrod\eBaySDK\MerchantData\PromotionalSaleDetailsType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AdminEnded');
        if (null !== $value) {
            $this->setAdminEnded($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SoldAsBin');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SuggestedBidValues', true);
