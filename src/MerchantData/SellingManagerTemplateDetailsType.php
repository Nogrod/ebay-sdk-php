...
class SellingManagerTemplateDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ItemType $template
     */
     ...
     * ItemType object that contains the data for the specified template.
     *
     * @param \Nogrod\eBaySDK\MerchantData\ItemType $template
     * @return self
     */
    public function setTemplate(\Nogrod\eBaySDK\MerchantData\ItemType $template)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Template');
        if (null !== $value) {
            $this->setTemplate(\Nogrod\eBaySDK\MerchantData\ItemType::fromKeyValue($value));
        }
    }
