...
class MerchantDataClassMap
{
    ...
    public static function GetElements()
    {
        ...
        '{urn:ebay:apis:eBLBaseComponents}SoldReportRequest' => 'Nogrod\eBaySDK\MerchantData\SoldReportRequest',
        '{urn:ebay:apis:eBLBaseComponents}RelistItemRequest' => 'Nogrod\eBaySDK\MerchantData\RelistItemRequest',
        '{urn:ebay:apis:eBLBaseComponents}ItemsCanceledEvent' => 'Nogrod\eBaySDK\MerchantData\ItemsCanceledEvent',
        ...
        '{urn:ebay:apis:eBLBaseComponents}SoldReport' => 'Nogrod\eBaySDK\MerchantData\SoldReport',
