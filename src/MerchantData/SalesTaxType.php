...
class SalesTaxType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $salesTaxAmount
     */
     ...
     *  the <b>OrderLineItemID</b> to call <b>GetOrderTransactions</b>.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $salesTaxAmount
     * @return self
     */
    public function setSalesTaxAmount(\Nogrod\eBaySDK\MerchantData\AmountType $salesTaxAmount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setSalesTaxAmount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
