...
class StoreCustomCategoryArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\StoreCustomCategoryType[] $customCategory
     */
     ...
     */
    public function addToCustomCategory(\Nogrod\eBaySDK\MerchantData\StoreCustomCategoryType $customCategory)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setCustomCategory(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\StoreCustomCategoryType::fromKeyValue($v);}, $value));
        }
    }
}
