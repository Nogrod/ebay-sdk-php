...
class ReviewDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\ReviewType[] $review
     */
    private $review = [
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ReviewType $review
     */
    public function addToReview(\Nogrod\eBaySDK\MerchantData\ReviewType $review)
    {
        $this->review[] = $review;
        return $this;
    }
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ReviewType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AverageRating');
        if (null !== $value) {
            $this->setAverageRating($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Review', true);
