...
class PictureManagerPictureType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\PictureManagerPictureDisplayType[] $displayFormat
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PictureManagerPictureDisplayType $displayFormat
     */
    public function addToDisplayFormat(\Nogrod\eBaySDK\MerchantData\PictureManagerPictureDisplayType $displayFormat)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PictureManagerPictureDisplayType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DisplayFormat', true);
        if (null !== $value && !empty($value)) {
            $this->setDisplayFormat(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\PictureManagerPictureDisplayType::fromKeyValue($v);
            }, $value));
        }
    }
