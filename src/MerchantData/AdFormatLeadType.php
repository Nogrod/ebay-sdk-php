...
class AdFormatLeadType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MemberMessageExchangeType[] $memberMessage
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $leadFee
     */
     ...
     */
    public function addToMemberMessage(\Nogrod\eBaySDK\MerchantData\MemberMessageExchangeType $memberMessageExchange)
    {
     ...
     * Contains any mail message content shared between the seller and prospective buyer.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MemberMessageExchangeType[] $memberMessage
     * @return self
     */
     ...
     *  be removed from the WSDL.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $leadFee
     * @return self
     */
    public function setLeadFee(\Nogrod\eBaySDK\MerchantData\AmountType $leadFee)
    {
