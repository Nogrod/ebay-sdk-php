...
class BuyingGuideDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\BuyingGuideType[] $buyingGuide
     */
    private $buyingGuide = [
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\BuyingGuideType $buyingGuide
     */
    public function addToBuyingGuide(\Nogrod\eBaySDK\MerchantData\BuyingGuideType $buyingGuide)
    {
     ...
     *  digital camera is right for them.
     *
     * @return \Nogrod\eBaySDK\MerchantData\BuyingGuideType[]
     */
