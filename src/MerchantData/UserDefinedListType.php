...
class UserDefinedListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSearchListType $favoriteSearches
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerListType $favoriteSellers
     */
     ...
     * An array of Favorite Searches that the user has added to the user-defined list.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSearchListType
     */
     ...
     * An array of Favorite Searches that the user has added to the user-defined list.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSearchListType $favoriteSearches
     * @return self
     */
    public function setFavoriteSearches(\Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSearchListType $favoriteSearches)
    {
     ...
     * An array of Favorite Sellers that the user has added to the user-defined list.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerListType
     */
     ...
     * An array of Favorite Sellers that the user has added to the user-defined list.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerListType $favoriteSellers
     * @return self
     */
    public function setFavoriteSellers(\Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerListType $favoriteSellers)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ItemCount');
        if (null !== $value) {
            $this->setItemCount($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteSearcheCount');
        if (null !== $value) {
            $this->setFavoriteSearcheCount($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteSellerCount');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteSearches');
        if (null !== $value) {
            $this->setFavoriteSearches(\Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSearchListType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteSellers');
        if (null !== $value) {
            $this->setFavoriteSellers(\Nogrod\eBaySDK\MerchantData\MyeBayFavoriteSellerListType::fromKeyValue($value));
        }
    }
