...
class ShipmentLineItemType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\LineItemType[] $lineItem
     */
    private $lineItem = [
     ...
     */
    public function addToLineItem(\Nogrod\eBaySDK\MerchantData\LineItemType $lineItem)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}LineItem', true);
