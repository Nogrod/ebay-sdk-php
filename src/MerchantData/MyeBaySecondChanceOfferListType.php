...
class MyeBaySecondChanceOfferListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ItemType $secondChanceOffer
     */
    public function addToSecondChanceOffer(\Nogrod\eBaySDK\MerchantData\ItemType $secondChanceOffer)
    {
