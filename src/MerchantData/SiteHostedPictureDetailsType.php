...
class SiteHostedPictureDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PictureSetMemberType $pictureSetMember
     */
    public function addToPictureSetMember(\Nogrod\eBaySDK\MerchantData\PictureSetMemberType $pictureSetMember)
    {
     ...
     * The URL and size information for each generated image.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PictureSetMemberType[]
     */
