...
class SiteBuyerRequirementDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\MaximumBuyerPolicyViolationsDetailsType $maximumBuyerPolicyViolations
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsDetailsType $maximumItemRequirements
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoDetailsType $maximumUnpaidItemStrikesInfo
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\VerifiedUserRequirementsDetailsType $verifiedUserRequirements
     */
     ...
     *  </span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumBuyerPolicyViolationsDetailsType
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\MaximumBuyerPolicyViolationsDetailsType $maximumBuyerPolicyViolations
     * @return self
     */
    public function setMaximumBuyerPolicyViolations(\Nogrod\eBaySDK\MerchantData\MaximumBuyerPolicyViolationsDetailsType $maximumBuyerPolicyViolations)
    {
     ...
     * This container shows the supported values that can be set as the <b>MaximumItemCount</b> and <b>MinimumFeedbackScore</b> to help control inexperienced or low Feedback bidders/buyers from bidding on or buying an item in a listing.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsDetailsType
     */
     ...
     * This container shows the supported values that can be set as the <b>MaximumItemCount</b> and <b>MinimumFeedbackScore</b> to help control inexperienced or low Feedback bidders/buyers from bidding on or buying an item in a listing.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsDetailsType $maximumItemRequirements
     * @return self
     */
    public function setMaximumItemRequirements(\Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsDetailsType $maximumItemRequirements)
    {
     ...
     * This container shows the supported values that can be set as the Maximum Unpaid Item count and period (number of days) to block buyers who have recent Unpaid Item Strikes from bidding on or buying an item in a listing.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoDetailsType
     */
     ...
     * This container shows the supported values that can be set as the Maximum Unpaid Item count and period (number of days) to block buyers who have recent Unpaid Item Strikes from bidding on or buying an item in a listing.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoDetailsType $maximumUnpaidItemStrikesInfo
     * @return self
     */
    public function setMaximumUnpaidItemStrikesInfo(\Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoDetailsType $maximumUnpaidItemStrikesInfo)
    {
     ...
     * The Verified User Buyer Requirement has been deprecated, so this field is no longer applicable.
     *
     * @return \Nogrod\eBaySDK\MerchantData\VerifiedUserRequirementsDetailsType
     */
     ...
     * The Verified User Buyer Requirement has been deprecated, so this field is no longer applicable.
     *
     * @param \Nogrod\eBaySDK\MerchantData\VerifiedUserRequirementsDetailsType $verifiedUserRequirements
     * @return self
     */
    public function setVerifiedUserRequirements(\Nogrod\eBaySDK\MerchantData\VerifiedUserRequirementsDetailsType $verifiedUserRequirements)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}LinkedPayPalAccount');
        if (null !== $value) {
            $this->setLinkedPayPalAccount($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumBuyerPolicyViolations');
        if (null !== $value) {
            $this->setMaximumBuyerPolicyViolations(\Nogrod\eBaySDK\MerchantData\MaximumBuyerPolicyViolationsDetailsType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumItemRequirements');
        if (null !== $value) {
            $this->setMaximumItemRequirements(\Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsDetailsType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumUnpaidItemStrikesInfo');
        if (null !== $value) {
            $this->setMaximumUnpaidItemStrikesInfo(\Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoDetailsType::fromKeyValue($value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}VerifiedUserRequirements');
        if (null !== $value) {
            $this->setVerifiedUserRequirements(\Nogrod\eBaySDK\MerchantData\VerifiedUserRequirementsDetailsType::fromKeyValue($value));
        }
