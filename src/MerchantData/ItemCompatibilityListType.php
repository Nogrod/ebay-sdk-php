...
class ItemCompatibilityListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ItemCompatibilityType $compatibility
     */
    public function addToCompatibility(\Nogrod\eBaySDK\MerchantData\ItemCompatibilityType $compatibility)
    {
     ...
     *  </span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\ItemCompatibilityType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Compatibility', true);
        if (null !== $value && !empty($value)) {
            $this->setCompatibility(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ItemCompatibilityType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ReplaceAll');
        if (null !== $value) {
