...
class MaximumUnpaidItemStrikesInfoDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesDurationDetailsType $maximumUnpaidItemStrikesDuration
     */
    public function addToMaximumUnpaidItemStrikesDuration(\Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesDurationDetailsType $maximumUnpaidItemStrikesDuration)
    {
     ...
     * Range of time used to determine maximum unpaid item count. This is applicable only to sellers.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesDurationDetailsType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumUnpaidItemStrikesCount', true);
        if (null !== $value && !empty($value)) {
            $this->setMaximumUnpaidItemStrikesCount($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumUnpaidItemStrikesDuration', true);
        if (null !== $value && !empty($value)) {
            $this->setMaximumUnpaidItemStrikesDuration(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesDurationDetailsType::fromKeyValue($v);
            }, $value));
        }
    }
