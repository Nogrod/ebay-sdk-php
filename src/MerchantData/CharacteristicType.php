...
class CharacteristicType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\LabelType $label
     */
    private $label = null;
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\ValType[] $valueList
     */
    private $valueList = [
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\LabelType
     */
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\MerchantData\LabelType $label
     * @return self
     */
    public function setLabel(\Nogrod\eBaySDK\MerchantData\LabelType $label)
    {
        $this->label = $label;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ValType $valueList
     */
    public function addToValueList(\Nogrod\eBaySDK\MerchantData\ValType $valueList)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setLabel(\Nogrod\eBaySDK\MerchantData\LabelType::fromKeyValue($value));
        }
