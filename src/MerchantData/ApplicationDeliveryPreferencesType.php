...
class ApplicationDeliveryPreferencesType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\DeliveryURLDetailType[] $deliveryURLDetails
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\DeliveryURLDetailType $deliveryURLDetails
     */
    public function addToDeliveryURLDetails(\Nogrod\eBaySDK\MerchantData\DeliveryURLDetailType $deliveryURLDetails)
    {
     ...
     *  URL(s) if ApplicationDeliveryPreferencesType.ApplicationEnable is set to Enable.
     *
     * @return \Nogrod\eBaySDK\MerchantData\DeliveryURLDetailType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setDeliveryURLDetails(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\DeliveryURLDetailType::fromKeyValue($v);}, $value));
        }
    }
}
