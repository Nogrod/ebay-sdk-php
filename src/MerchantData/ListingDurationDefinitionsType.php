...
class ListingDurationDefinitionsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ListingDurationDefinitionType[] $listingDuration
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ListingDurationDefinitionType $listingDuration
     */
    public function addToListingDuration(\Nogrod\eBaySDK\MerchantData\ListingDurationDefinitionType $listingDuration)
    {
     ...
     * A <b>ListingDurations</b> container is returned for each listing type supported for the eBay site, and the supported listing duration times for those listing types. The <b>durationSetID</b> attribute value indicates the listing type.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ListingDurationDefinitionType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setListingDuration(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ListingDurationDefinitionType::fromKeyValue($v);
            }, $value));
        }
    }
