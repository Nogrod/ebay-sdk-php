...
class PaymentsInformationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\PaymentTransactionType[] $payments
     */
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundTransactionInfoType[] $refunds
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PaymentTransactionType $payment
     */
    public function addToPayments(\Nogrod\eBaySDK\MerchantData\PaymentTransactionType $payment)
    {
     ...
     * Contains information about how different portions of the funds exchanged for a specified order are allocated among payees. Each allocated portion is represented by a <strong>Payment</strong> container.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PaymentTransactionType[]
     */
     ...
     * Contains information about how different portions of the funds exchanged for a specified order are allocated among payees. Each allocated portion is represented by a <strong>Payment</strong> container.
     *
     * @param \Nogrod\eBaySDK\MerchantData\PaymentTransactionType[] $payments
     * @return self
     */
     ...
     */
    public function addToRefunds(\Nogrod\eBaySDK\MerchantData\RefundTransactionInfoType $refund)
    {
        $this->refunds[] = $refund;
        return $this;
    }
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\RefundTransactionInfoType[] $refunds
     * @return self
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Refunds', true);
        if (null !== $value && !empty($value)) {
