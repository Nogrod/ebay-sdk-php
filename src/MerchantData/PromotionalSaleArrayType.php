...
class PromotionalSaleArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  Promotional Sales are only available to eBay sellers who are eBay Store subscribers.
     *
     * @var \Nogrod\eBaySDK\MerchantData\PromotionalSaleType[] $promotionalSale
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PromotionalSaleType $promotionalSale
     */
    public function addToPromotionalSale(\Nogrod\eBaySDK\MerchantData\PromotionalSaleType $promotionalSale)
    {
     ...
     *  Promotional Sales are only available to eBay sellers who are eBay Store subscribers.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PromotionalSaleType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setPromotionalSale(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\PromotionalSaleType::fromKeyValue($v);
            }, $value));
        }
    }
}
