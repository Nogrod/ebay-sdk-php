...
class RefundTransactionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundLineType[] $refundLineArray
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\RefundLineType $refundLine
     */
    public function addToRefundLineArray(\Nogrod\eBaySDK\MerchantData\RefundLineType $refundLine)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\RefundLineType[]
     */
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\MerchantData\RefundLineType[] $refundLineArray
     * @return self
     */
    ...
    public function xmlSerialize(\Sabre\Xml\Writer $writer): void
    {
        ...
        if (null !== $value && !empty($this->getRefundLineArray())) {
            $writer->writeElement("{urn:ebay:apis:eBLBaseComponents}RefundLineArray", array_map(function ($v) {return ["RefundLine" => $v];}, $value));
        }
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefundLineArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundLineType::fromKeyValue($v);}, $value));
        }
    }
}
