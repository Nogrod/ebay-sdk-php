...
class OrderTransactionArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\OrderTransactionType[] $orderTransaction
     */
     ...
     */
    public function addToOrderTransaction(\Nogrod\eBaySDK\MerchantData\OrderTransactionType $orderTransaction)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setOrderTransaction(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\OrderTransactionType::fromKeyValue($v);}, $value));
        }
    }
}
