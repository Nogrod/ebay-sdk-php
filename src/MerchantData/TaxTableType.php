...
class TaxTableType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\TaxJurisdictionType[] $taxJurisdiction
     */
     ...
     */
    public function addToTaxJurisdiction(\Nogrod\eBaySDK\MerchantData\TaxJurisdictionType $taxJurisdiction)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setTaxJurisdiction(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\TaxJurisdictionType::fromKeyValue($v);}, $value));
        }
    }
}
