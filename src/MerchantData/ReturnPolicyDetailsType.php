...
class ReturnPolicyDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefund(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundDetailsType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ReturnsWithin', true);
        if (null !== $value && !empty($value)) {
            $this->setReturnsWithin(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\ReturnsWithinDetailsType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ReturnsAccepted', true);
        if (null !== $value && !empty($value)) {
            $this->setReturnsAccepted(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\ReturnsAcceptedDetailsType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setWarrantyOffered(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\WarrantyOfferedDetailsType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}WarrantyType', true);
        if (null !== $value && !empty($value)) {
            $this->setWarrantyType(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\WarrantyTypeDetailsType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}WarrantyDuration', true);
        if (null !== $value && !empty($value)) {
            $this->setWarrantyDuration(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\WarrantyDurationDetailsType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setShippingCostPaidBy(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\ShippingCostPaidByDetailsType::fromKeyValue($v);}, $value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RestockingFeeValue', true);
        if (null !== $value && !empty($value)) {
            $this->setRestockingFeeValue(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RestockingFeeValueDetailsType::fromKeyValue($v);}, $value));
        }
