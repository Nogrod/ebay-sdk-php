...
class AddMemberMessagesAAQToBidderRequestContainerType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MemberMessageType $memberMessage
     */
     ...
     * This container consists of message body, the recipient(s) of the message, and a boolean flag to control whether or not a copy of the message is sent to the sender's My eBay Inbox.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MemberMessageType
     */
     ...
     * This container consists of message body, the recipient(s) of the message, and a boolean flag to control whether or not a copy of the message is sent to the sender's My eBay Inbox.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MemberMessageType $memberMessage
     * @return self
     */
    public function setMemberMessage(\Nogrod\eBaySDK\MerchantData\MemberMessageType $memberMessage)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setMemberMessage(\Nogrod\eBaySDK\MerchantData\MemberMessageType::fromKeyValue($value));
        }
    }
