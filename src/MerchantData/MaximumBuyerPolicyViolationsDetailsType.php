...
class MaximumBuyerPolicyViolationsDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PolicyViolationDurationDetailsType $policyViolationDuration
     */
    public function addToPolicyViolationDuration(\Nogrod\eBaySDK\MerchantData\PolicyViolationDurationDetailsType $policyViolationDuration)
    {
     ...
     * As a Maximum Buyer Policy Violations threshold value can no longer be set at the account or listing level, this field is no longer applicable.
     *
     * @return \Nogrod\eBaySDK\MerchantData\PolicyViolationDurationDetailsType[]
     */
