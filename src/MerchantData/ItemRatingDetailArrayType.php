...
class ItemRatingDetailArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ItemRatingDetailsType $itemRatingDetails
     */
    public function addToItemRatingDetails(\Nogrod\eBaySDK\MerchantData\ItemRatingDetailsType $itemRatingDetails)
    {
     ...
     *  Applicable to sites that support the Detailed Seller Ratings feature.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ItemRatingDetailsType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ItemRatingDetails', true);
