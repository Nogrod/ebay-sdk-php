...
class SupportedSellerProfileType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\CategoryGroupType $categoryGroup
     */
     ...
     *  categories) and MOTORS_VEHICLE (for motor vehicle listings).
     *
     * @return \Nogrod\eBaySDK\MerchantData\CategoryGroupType
     */
     ...
     *  categories) and MOTORS_VEHICLE (for motor vehicle listings).
     *
     * @param \Nogrod\eBaySDK\MerchantData\CategoryGroupType $categoryGroup
     * @return self
     */
    public function setCategoryGroup(\Nogrod\eBaySDK\MerchantData\CategoryGroupType $categoryGroup)
    {
