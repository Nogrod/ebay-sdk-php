...
class ListingRecommendationType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\MetadataType $metadata
     */
    public function addToMetadata(\Nogrod\eBaySDK\MerchantData\MetadataType $metadata)
    {
     ...
     *  A <b>Metadata</b> container is returned for each price guidance parameter that is applicable/available for the pricing recommendation.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MetadataType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Group');
        if (null !== $value) {
            $this->setGroup($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FieldName');
        if (null !== $value) {
            $this->setFieldName($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Code');
        if (null !== $value) {
            $this->setCode($value);
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Metadata', true);
        if (null !== $value && !empty($value)) {
            $this->setMetadata(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\MetadataType::fromKeyValue($v);
            }, $value));
        }
    }
