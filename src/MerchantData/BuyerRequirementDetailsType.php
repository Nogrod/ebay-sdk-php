...
class BuyerRequirementDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsType $maximumItemRequirements
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoType $maximumUnpaidItemStrikesInfo
     */
     ...
     * The seller uses this container as a mechanism to restrict the number of items (specifying a <b>MaximumItemCount</b> value) a prospective buyer can purchase from the seller during a 10-day period. The seller also has the option of setting a <b>MinimumFeedbackScore</b> requirement. If both fields of the <b>MaximumItemRequirements</b> container are set, the <b>MaximumItemCount</b> limit will only apply to those prospective buyers that don't equal or exceed the specified minimum Feedback Score.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsType
     */
     ...
     * The seller uses this container as a mechanism to restrict the number of items (specifying a <b>MaximumItemCount</b> value) a prospective buyer can purchase from the seller during a 10-day period. The seller also has the option of setting a <b>MinimumFeedbackScore</b> requirement. If both fields of the <b>MaximumItemRequirements</b> container are set, the <b>MaximumItemCount</b> limit will only apply to those prospective buyers that don't equal or exceed the specified minimum Feedback Score.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsType $maximumItemRequirements
     * @return self
     */
    public function setMaximumItemRequirements(\Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsType $maximumItemRequirements)
    {
     ...
     * The seller uses this container as a mechanism to block prospective buyers who have one or more Unpaid Item Strikes on their account during a specified time period. A buyer receives an Unpaid Item Strike is a seller files an Unpaid Item case against the buyer, and eBay rules in favor of the seller.
     *
     * @return \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoType
     */
     ...
     * The seller uses this container as a mechanism to block prospective buyers who have one or more Unpaid Item Strikes on their account during a specified time period. A buyer receives an Unpaid Item Strike is a seller files an Unpaid Item case against the buyer, and eBay rules in favor of the seller.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoType $maximumUnpaidItemStrikesInfo
     * @return self
     */
    public function setMaximumUnpaidItemStrikesInfo(\Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoType $maximumUnpaidItemStrikesInfo)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setMaximumItemRequirements(\Nogrod\eBaySDK\MerchantData\MaximumItemRequirementsType::fromKeyValue($value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaximumUnpaidItemStrikesInfo');
        if (null !== $value) {
            $this->setMaximumUnpaidItemStrikesInfo(\Nogrod\eBaySDK\MerchantData\MaximumUnpaidItemStrikesInfoType::fromKeyValue($value));
        }
    }
}
