...
class CharacteristicsSetType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\MerchantData\CharacteristicType[] $characteristics
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\CharacteristicType $characteristics
     */
    public function addToCharacteristics(\Nogrod\eBaySDK\MerchantData\CharacteristicType $characteristics)
    {
    ...
    public function xmlSerialize(\Sabre\Xml\Writer $writer): void
    {
        ...
        if (null !== $value && !empty($this->getCharacteristics())) {
            $writer->write(array_map(function ($v) {return ["Characteristics" => $v];}, $value));
        }
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setCharacteristics(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\CharacteristicType::fromKeyValue($v);}, $value));
        }
    }
}
