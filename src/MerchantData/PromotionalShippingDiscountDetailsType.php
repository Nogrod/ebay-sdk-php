...
class PromotionalShippingDiscountDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $orderAmount
     */
     ...
     *  when <b>DiscountName</b> is set to <code>ShippingCostXForAmountY</code>.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $orderAmount
     * @return self
     */
    public function setOrderAmount(\Nogrod\eBaySDK\MerchantData\AmountType $orderAmount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}OrderAmount');
        if (null !== $value) {
            $this->setOrderAmount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
