...
class DiscountPriceInfoType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $originalRetailPrice
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $minimumAdvertisedPrice
     */
     ...
     *  button quality, etc.)
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $madeForOutletComparisonPrice
     */
     ...
     *  <b>OriginalRetailPrice</b> to determine the amount of savings to the buyer.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $originalRetailPrice
     * @return self
     */
    public function setOriginalRetailPrice(\Nogrod\eBaySDK\MerchantData\AmountType $originalRetailPrice)
    {
     ...
     *  This only applies to fixed-price listings and auction listings with the Buy It Now option.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $minimumAdvertisedPrice
     * @return self
     */
    public function setMinimumAdvertisedPrice(\Nogrod\eBaySDK\MerchantData\AmountType $minimumAdvertisedPrice)
    {
     ...
     *  button quality, etc.)
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $madeForOutletComparisonPrice
     * @return self
     */
    public function setMadeForOutletComparisonPrice(\Nogrod\eBaySDK\MerchantData\AmountType $madeForOutletComparisonPrice)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setOriginalRetailPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MinimumAdvertisedPrice');
        if (null !== $value) {
            $this->setMinimumAdvertisedPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MadeForOutletComparisonPrice');
        if (null !== $value) {
            $this->setMadeForOutletComparisonPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
