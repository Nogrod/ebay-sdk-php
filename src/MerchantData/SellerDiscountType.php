...
class SellerDiscountType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $itemDiscountAmount
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $shippingDiscountAmount
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $itemDiscountAmount
     * @return self
     */
    public function setItemDiscountAmount(\Nogrod\eBaySDK\MerchantData\AmountType $itemDiscountAmount)
    {
     ...
     * The dollar amount of the shipping discount applied to the order line item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $shippingDiscountAmount
     * @return self
     */
    public function setShippingDiscountAmount(\Nogrod\eBaySDK\MerchantData\AmountType $shippingDiscountAmount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setItemDiscountAmount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShippingDiscountAmount');
        if (null !== $value) {
            $this->setShippingDiscountAmount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
}
