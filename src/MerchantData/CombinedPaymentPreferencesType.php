...
class CombinedPaymentPreferencesType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\CalculatedShippingPreferencesType $calculatedShippingPreferences
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\FlatShippingPreferencesType $flatShippingPreferences
     */
     ...
     * DO NOT USE THIS CONTAINER. As an alternative, use <b>SetShippingDiscountProfiles</b> to set all Calculated Shipping rules and preferences, and use <b>GetShippingDiscountProfiles</b> to retrieve the same information.
     *
     * @return \Nogrod\eBaySDK\MerchantData\CalculatedShippingPreferencesType
     */
     ...
     * DO NOT USE THIS CONTAINER. As an alternative, use <b>SetShippingDiscountProfiles</b> to set all Calculated Shipping rules and preferences, and use <b>GetShippingDiscountProfiles</b> to retrieve the same information.
     *
     * @param \Nogrod\eBaySDK\MerchantData\CalculatedShippingPreferencesType $calculatedShippingPreferences
     * @return self
     */
    public function setCalculatedShippingPreferences(\Nogrod\eBaySDK\MerchantData\CalculatedShippingPreferencesType $calculatedShippingPreferences)
    {
     ...
     * DO NOT USE THIS CONTAINER. As an alternative, use <b>SetShippingDiscountProfiles</b> to set all Flat Rate Shipping rules and preferences, and use <b>GetShippingDiscountProfiles</b> to retrieve the same information.
     *
     * @return \Nogrod\eBaySDK\MerchantData\FlatShippingPreferencesType
     */
     ...
     * DO NOT USE THIS CONTAINER. As an alternative, use <b>SetShippingDiscountProfiles</b> to set all Flat Rate Shipping rules and preferences, and use <b>GetShippingDiscountProfiles</b> to retrieve the same information.
     *
     * @param \Nogrod\eBaySDK\MerchantData\FlatShippingPreferencesType $flatShippingPreferences
     * @return self
     */
    public function setFlatShippingPreferences(\Nogrod\eBaySDK\MerchantData\FlatShippingPreferencesType $flatShippingPreferences)
    {
