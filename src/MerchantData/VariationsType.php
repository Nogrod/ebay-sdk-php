...
class VariationsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  in the future.</span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\PicturesType[] $pictures
     */
    private $pictures = [
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\NameValueListType[] $variationSpecificsSet
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\ModifyNameType[] $modifyNameList
     */
     ...
     */
    public function addToVariation(\Nogrod\eBaySDK\MerchantData\VariationType $variation)
    {
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\PicturesType $pictures
     */
    public function addToPictures(\Nogrod\eBaySDK\MerchantData\PicturesType $pictures)
    {
     ...
     *  in the future.</span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\PicturesType[]
     */
     ...
     */
    public function addToVariationSpecificsSet(\Nogrod\eBaySDK\MerchantData\NameValueListType $nameValueList)
    {
     ...
     *  RelistFixedPriceItem.
     *
     * @param \Nogrod\eBaySDK\MerchantData\NameValueListType[] $variationSpecificsSet
     * @return self
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ModifyNameType $modifyName
     */
    public function addToModifyNameList(\Nogrod\eBaySDK\MerchantData\ModifyNameType $modifyName)
    {
     ...
     *  Variation, Pictures, VariationSpecificsSet, or ModifyNameList (or all) need to be specified when the Variations node is specified in listing requests.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ModifyNameType[]
     */
     ...
     *  Variation, Pictures, VariationSpecificsSet, or ModifyNameList (or all) need to be specified when the Variations node is specified in listing requests.
     *
     * @param \Nogrod\eBaySDK\MerchantData\ModifyNameType[] $modifyNameList
     * @return self
     */
