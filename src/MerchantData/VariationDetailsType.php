...
class VariationDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaxVariationsPerItem');
        if (null !== $value) {
            $this->setMaxVariationsPerItem($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaxNamesPerVariationSpecificsSet');
        if (null !== $value) {
            $this->setMaxNamesPerVariationSpecificsSet($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaxValuesPerVariationSpecificsSetName');
        if (null !== $value) {
