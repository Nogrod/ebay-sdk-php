...
class RecommendationsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\ProductIdentifiersType[] $productIdentifiers
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ProductIdentifiersType $productIdentifiers
     */
    public function addToProductIdentifiers(\Nogrod\eBaySDK\MerchantData\ProductIdentifiersType $productIdentifiers)
    {
     ...
     *  </span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\ProductIdentifiersType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ProductIdentifiers', true);
        if (null !== $value && !empty($value)) {
            $this->setProductIdentifiers(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ProductIdentifiersType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NameRecommendation', true);
        if (null !== $value && !empty($value)) {
            $this->setNameRecommendation(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\NameRecommendationType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Updated');
        if (null !== $value) {
