...
class SuggestedBidValueType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType[] $bidValue
     */
    private $bidValue = [
     ...
     */
    public function addToBidValue(\Nogrod\eBaySDK\MerchantData\AmountType $bidValue)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BidValue', true);
