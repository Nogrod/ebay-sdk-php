...
class TransactionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\TransactionProgramType $program
     */
     ...
     *  This container is only returned for order line items subject to the Authenticity Guarantee service process, and if it is returned, the seller must make sure to send the item to the third-party authenticator's address (shown in the <b>MultiLegShippingDetails.SellerShipmentToLogisticsProvider.ShipToAddress</b> field), and not to the buyer's shipping address. If the item is successfully authenticated, the authenticator will ship the item to the buyer.
     *
     * @return \Nogrod\eBaySDK\MerchantData\TransactionProgramType
     */
     ...
     *  This container is only returned for order line items subject to the Authenticity Guarantee service process, and if it is returned, the seller must make sure to send the item to the third-party authenticator's address (shown in the <b>MultiLegShippingDetails.SellerShipmentToLogisticsProvider.ShipToAddress</b> field), and not to the buyer's shipping address. If the item is successfully authenticated, the authenticator will ship the item to the buyer.
     *
     * @param \Nogrod\eBaySDK\MerchantData\TransactionProgramType $program
     * @return self
     */
    public function setProgram(\Nogrod\eBaySDK\MerchantData\TransactionProgramType $program)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setExternalTransaction(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\ExternalTransactionType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefundArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setPickupDetails(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\PickupOptionsType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setBuyerPackageEnclosures(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\BuyerPackageEnclosureType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value) {
            $this->setProgram(\Nogrod\eBaySDK\MerchantData\TransactionProgramType::fromKeyValue($value));
        }
    }
}
