...
class SellereBayPaymentProcessConsentCodeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\UserAgreementInfoType $userAgreementInfo
     */
    public function addToUserAgreementInfo(\Nogrod\eBaySDK\MerchantData\UserAgreementInfoType $userAgreementInfo)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\UserAgreementInfoType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setUserAgreementInfo(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\UserAgreementInfoType::fromKeyValue($v);}, $value));
        }
    }
}
