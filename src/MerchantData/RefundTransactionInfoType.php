...
class RefundTransactionInfoType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\UserIdentityType $refundTo
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\UserIdentityType $refundTo
     * @return self
     */
    public function setRefundTo(\Nogrod\eBaySDK\MerchantData\UserIdentityType $refundTo)
    {
