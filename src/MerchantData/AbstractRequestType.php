...
class AbstractRequestType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\XMLRequesterCredentialsType $requesterCredentials
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\BotBlockRequestType $botBlock
     */
     ...
     *  member's username and password instead.)
     *
     * @return \Nogrod\eBaySDK\MerchantData\XMLRequesterCredentialsType
     */
     ...
     *  member's username and password instead.)
     *
     * @param \Nogrod\eBaySDK\MerchantData\XMLRequesterCredentialsType $requesterCredentials
     * @return self
     */
    public function setRequesterCredentials(\Nogrod\eBaySDK\MerchantData\XMLRequesterCredentialsType $requesterCredentials)
    {
     ...
     * This container is only used by the <b>PlaceOffer</b> call request if the previous <b>PlaceOffer</b> call resulted in a <b>BotBlock</b> container in the response. If the caller receives this container in the response, that caller must make another <b>PlaceOffer</b> call, this time, passing in the encrypted token and URL that is returned in the <b>BotBlock</b> container in the response. This safeguard lets eBay know that a real user is making a <b>PlaceOffer</b> call and not a bot.
     *
     * @return \Nogrod\eBaySDK\MerchantData\BotBlockRequestType
     */
     ...
     * This container is only used by the <b>PlaceOffer</b> call request if the previous <b>PlaceOffer</b> call resulted in a <b>BotBlock</b> container in the response. If the caller receives this container in the response, that caller must make another <b>PlaceOffer</b> call, this time, passing in the encrypted token and URL that is returned in the <b>BotBlock</b> container in the response. This safeguard lets eBay know that a real user is making a <b>PlaceOffer</b> call and not a bot.
     *
     * @param \Nogrod\eBaySDK\MerchantData\BotBlockRequestType $botBlock
     * @return self
     */
    public function setBotBlock(\Nogrod\eBaySDK\MerchantData\BotBlockRequestType $botBlock)
    {
