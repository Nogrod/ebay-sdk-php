...
class ErrorType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\ErrorParameterType $errorParameters
     */
    public function addToErrorParameters(\Nogrod\eBaySDK\MerchantData\ErrorParameterType $errorParameters)
    {
     ...
     *  These are useful when multiple instances of <b>ErrorType</b> are returned.
     *
     * @return \Nogrod\eBaySDK\MerchantData\ErrorParameterType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}UserDisplayHint');
        if (null !== $value) {
            $this->setUserDisplayHint($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SeverityCode');
        if (null !== $value) {
            $this->setSeverityCode($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ErrorParameters', true);
        if (null !== $value && !empty($value)) {
            $this->setErrorParameters(array_map(function ($v) {
                return \Nogrod\eBaySDK\MerchantData\ErrorParameterType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ErrorClassification');
        if (null !== $value) {
