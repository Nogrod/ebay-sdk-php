...
class PaymentInformationCodeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\PaymentTransactionCodeType[] $payment
     */
    private $payment = [
     ...
     */
    public function addToPayment(\Nogrod\eBaySDK\MerchantData\PaymentTransactionCodeType $payment)
    {
