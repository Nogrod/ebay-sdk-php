...
class DigitalDeliverySelectedType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\DeliveryStatusType $deliveryStatus
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\DeliveryDetailsType $deliveryDetails
     */
     ...
     * This container consists of the current status of whatever delivery method is being used (indicated in the <b>DigitalDeliverySelected.DeliveryMethod</b> field). Currently, the only supported delivery method is by email.
     *
     * @return \Nogrod\eBaySDK\MerchantData\DeliveryStatusType
     */
     ...
     * This container consists of the current status of whatever delivery method is being used (indicated in the <b>DigitalDeliverySelected.DeliveryMethod</b> field). Currently, the only supported delivery method is by email.
     *
     * @param \Nogrod\eBaySDK\MerchantData\DeliveryStatusType $deliveryStatus
     * @return self
     */
    public function setDeliveryStatus(\Nogrod\eBaySDK\MerchantData\DeliveryStatusType $deliveryStatus)
    {
     ...
     * This container is returned by <b>GetOrders</b> and other order management calls to provide details on the recipient of a digital gift card that was purchased. The <b>DeliveryDetails</b> container is only returned if the buyer is buying a digital gift card and giving that gift card to another person.
     *
     * @return \Nogrod\eBaySDK\MerchantData\DeliveryDetailsType
     */
     ...
     * This container is returned by <b>GetOrders</b> and other order management calls to provide details on the recipient of a digital gift card that was purchased. The <b>DeliveryDetails</b> container is only returned if the buyer is buying a digital gift card and giving that gift card to another person.
     *
     * @param \Nogrod\eBaySDK\MerchantData\DeliveryDetailsType $deliveryDetails
     * @return self
     */
    public function setDeliveryDetails(\Nogrod\eBaySDK\MerchantData\DeliveryDetailsType $deliveryDetails)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DeliveryMethod');
        if (null !== $value) {
            $this->setDeliveryMethod($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DeliveryStatus');
        if (null !== $value) {
            $this->setDeliveryStatus(\Nogrod\eBaySDK\MerchantData\DeliveryStatusType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DeliveryDetails');
        if (null !== $value) {
            $this->setDeliveryDetails(\Nogrod\eBaySDK\MerchantData\DeliveryDetailsType::fromKeyValue($value));
        }
    }
