...
class FeeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $promotionalDiscount
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $promotionalDiscount
     * @return self
     */
    public function setPromotionalDiscount(\Nogrod\eBaySDK\MerchantData\AmountType $promotionalDiscount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PromotionalDiscount');
        if (null !== $value) {
            $this->setPromotionalDiscount(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
