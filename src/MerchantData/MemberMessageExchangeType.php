...
class MemberMessageExchangeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\MemberMessageType $question
     */
     ...
     *  parent container is returned.
     *
     * @param \Nogrod\eBaySDK\MerchantData\MemberMessageType $question
     * @return self
     */
    public function setQuestion(\Nogrod\eBaySDK\MerchantData\MemberMessageType $question)
    {
