...
class ShippingServiceCostOverrideType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $shippingSurcharge
     */
     ...
     *  This field can only be used if the shipping surcharges are applicable for the corresponding shipping service.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $shippingSurcharge
     * @return self
     */
    public function setShippingSurcharge(\Nogrod\eBaySDK\MerchantData\AmountType $shippingSurcharge)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShippingServiceType');
        if (null !== $value) {
        ...
        if (null !== $value) {
            $this->setShippingSurcharge(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
