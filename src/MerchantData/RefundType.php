...
class RefundType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefundTransactionArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundTransactionType::fromKeyValue($v);}, $value));
        }
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefundFundingSourceArray(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\RefundFundingSourceType::fromKeyValue($v);}, $value));
        }
