...
class RefundType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $refundFromSeller
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $totalRefundToBuyer
     */
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundTransactionType[] $refundTransactionArray
     */
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundFailureReasonType $refundFailureReason
     */
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\MerchantData\RefundFundingSourceType[] $refundFundingSourceArray
     */
     ...
     *  Total amount refunded by the seller for this order line item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $refundFromSeller
     * @return self
     */
    public function setRefundFromSeller(\Nogrod\eBaySDK\MerchantData\AmountType $refundFromSeller)
    {
     ...
     *  Total amount refunded to the buyer for this order line item.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $totalRefundToBuyer
     * @return self
     */
    public function setTotalRefundToBuyer(\Nogrod\eBaySDK\MerchantData\AmountType $totalRefundToBuyer)
    {
     ...
     */
    public function addToRefundTransactionArray(\Nogrod\eBaySDK\MerchantData\RefundTransactionType $refundTransaction)
    {
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\RefundTransactionType[] $refundTransactionArray
     * @return self
     */
     ...
     *  </span>
     *
     * @return \Nogrod\eBaySDK\MerchantData\RefundFailureReasonType
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\RefundFailureReasonType $refundFailureReason
     * @return self
     */
    public function setRefundFailureReason(\Nogrod\eBaySDK\MerchantData\RefundFailureReasonType $refundFailureReason)
    {
     ...
     */
    public function addToRefundFundingSourceArray(\Nogrod\eBaySDK\MerchantData\RefundFundingSourceType $refundFundingSource)
    {
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\MerchantData\RefundFundingSourceType[] $refundFundingSourceArray
     * @return self
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundFromSeller');
        if (null !== $value) {
            $this->setRefundFromSeller(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TotalRefundToBuyer');
        if (null !== $value) {
            $this->setTotalRefundToBuyer(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundTime');
        if (null !== $value) {
            $this->setRefundTime(new \DateTime($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundID');
        if (null !== $value) {
            $this->setRefundID($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundTransactionArray', true);
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundFailureReason');
        if (null !== $value) {
            $this->setRefundFailureReason(\Nogrod\eBaySDK\MerchantData\RefundFailureReasonType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundFundingSourceArray', true);
        if (null !== $value && !empty($value)) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ExternalReferenceID');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RefundCompletionTime');
        if (null !== $value) {
            $this->setRefundCompletionTime(new \DateTime($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}EstimatedRefundCompletionTime');
        if (null !== $value) {
            $this->setEstimatedRefundCompletionTime(new \DateTime($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerNoteToBuyer');
        if (null !== $value) {
