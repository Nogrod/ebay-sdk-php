...
class SellerFavoriteItemPreferencesType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $minPrice
     */
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $maxPrice
     */
     ...
     * Specifies the lower limit of price range for the automatic search criteria.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $minPrice
     * @return self
     */
    public function setMinPrice(\Nogrod\eBaySDK\MerchantData\AmountType $minPrice)
    {
     ...
     * Specifies the upper limit of price range for the automatic search criteria.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $maxPrice
     * @return self
     */
    public function setMaxPrice(\Nogrod\eBaySDK\MerchantData\AmountType $maxPrice)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SearchKeywords');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SearchSortOrder');
        if (null !== $value) {
            $this->setSearchSortOrder($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MinPrice');
        if (null !== $value) {
            $this->setMinPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaxPrice');
        if (null !== $value) {
            $this->setMaxPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FavoriteItemID', true);
