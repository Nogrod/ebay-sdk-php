...
class BidGroupArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\BidGroupType $bidGroup
     */
    public function addToBidGroup(\Nogrod\eBaySDK\MerchantData\BidGroupType $bidGroup)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\BidGroupType[]
     */
    ...
    public function xmlSerialize(\Sabre\Xml\Writer $writer): void
    {
        ...
        if (null !== $value && !empty($this->getBidGroup())) {
            $writer->write(array_map(function ($v) {return ["BidGroup" => $v];}, $value));
        }
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setBidGroup(array_map(function ($v) {return \Nogrod\eBaySDK\MerchantData\BidGroupType::fromKeyValue($v);}, $value));
        }
    }
}
