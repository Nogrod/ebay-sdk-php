...
class UnitOfMeasurementDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\UnitOfMeasurementType[] $unitOfMeasurement
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\UnitOfMeasurementType $unitOfMeasurement
     */
    public function addToUnitOfMeasurement(\Nogrod\eBaySDK\MerchantData\UnitOfMeasurementType $unitOfMeasurement)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\UnitOfMeasurementType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}UnitOfMeasurement', true);
