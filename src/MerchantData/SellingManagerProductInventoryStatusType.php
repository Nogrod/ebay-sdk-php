...
class SellingManagerProductInventoryStatusType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\AmountType $averageSellingPrice
     */
     ...
     * Average selling price for the product.
     *
     * @param \Nogrod\eBaySDK\MerchantData\AmountType $averageSellingPrice
     * @return self
     */
    public function setAverageSellingPrice(\Nogrod\eBaySDK\MerchantData\AmountType $averageSellingPrice)
    {
    ...
    {
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}QuantityScheduled');
        if (null !== $value) {
            $this->setQuantityScheduled($value);
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}QuantityActive');
        if (null !== $value) {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}QuantityUnsold');
        if (null !== $value) {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AverageSellingPrice');
        if (null !== $value) {
            $this->setAverageSellingPrice(\Nogrod\eBaySDK\MerchantData\AmountType::fromKeyValue($value));
        }
    }
}
