...
class ProductSearchPageType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\MerchantData\CharacteristicsSetType $searchCharacteristicsSet
     */
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\MerchantData\CharacteristicsSetType $searchCharacteristicsSet
     * @return self
     */
    public function setSearchCharacteristicsSet(\Nogrod\eBaySDK\MerchantData\CharacteristicsSetType $searchCharacteristicsSet)
    {
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\CharacteristicType $sortCharacteristics
     */
    public function addToSortCharacteristics(\Nogrod\eBaySDK\MerchantData\CharacteristicType $sortCharacteristics)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\CharacteristicType[]
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\MerchantData\DataElementSetType $dataElementSet
     */
    public function addToDataElementSet(\Nogrod\eBaySDK\MerchantData\DataElementSetType $dataElementSet)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\MerchantData\DataElementSetType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SearchCharacteristicsSet');
        if (null !== $value) {
            $this->setSearchCharacteristicsSet(\Nogrod\eBaySDK\MerchantData\CharacteristicsSetType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SearchType');
        if (null !== $value) {
            $this->setSearchType($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SortCharacteristics', true);
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DataElementSet', true);
        if (null !== $value && !empty($value)) {
