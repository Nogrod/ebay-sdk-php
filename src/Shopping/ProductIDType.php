 ...
 *
 * This type consists of an attribute that is used by the <b>ProductID</b> field in Shopping API calls to identify the type of product identifier that is used to identify a product.
 * XSD Type: ProductIDType
 */
