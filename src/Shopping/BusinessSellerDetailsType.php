 ...
 *
 * Type used by the <b>BusinessSellerDetails</b> container, which is returned if an item's seller is registered on eBay as a Business Seller. Note that this type is only applicable for eBay sites that support Business Seller accounts.
...
class BusinessSellerDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Shopping\AddressType $address
     */
     ...
     *
     * @var \Nogrod\eBaySDK\Shopping\VATDetailsType $vATDetails
     */
     ...
     * This field shows the address on file for the Business Seller.
     *
     * @return \Nogrod\eBaySDK\Shopping\AddressType
     */
     ...
     * This field shows the address on file for the Business Seller.
     *
     * @param \Nogrod\eBaySDK\Shopping\AddressType $address
     * @return self
     */
    public function setAddress(\Nogrod\eBaySDK\Shopping\AddressType $address)
    {
     ...
     * This container provides Value-Added Tax (VAT) details for the Business Seller, including the seller's VAT ID and the VAT percentage rate applicable to the item. VAT is similar to a sales and/or consumption tax, and it is only applicable to sellers selling on European sites.
     *
     * @return \Nogrod\eBaySDK\Shopping\VATDetailsType
     */
     ...
     * This container provides Value-Added Tax (VAT) details for the Business Seller, including the seller's VAT ID and the VAT percentage rate applicable to the item. VAT is similar to a sales and/or consumption tax, and it is only applicable to sellers selling on European sites.
     *
     * @param \Nogrod\eBaySDK\Shopping\VATDetailsType $vATDetails
     * @return self
     */
    public function setVATDetails(\Nogrod\eBaySDK\Shopping\VATDetailsType $vATDetails)
    {
