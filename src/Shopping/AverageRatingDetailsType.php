 ...
 *  The <b>AverageRatingDetails</b> container consists of the average detailed seller ratings in an area. When buyers leave an overall Feedback rating (positive, neutral, or negative) for a seller, they also can leave ratings in four areas: item as described, communication, shipping time, and charges for shipping and handling. Users retrieve detailed ratings as averages of the ratings left by buyers. The <b>AverageRatingDetails</b> container is only returned in the <b>GetUserProfile</b> call if the <b>IncludeSelector</b> field is included in the call request and set to <b>FeedbackHistory</b>
...
class AverageRatingDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}RatingCount');
        if (null !== $value) {
