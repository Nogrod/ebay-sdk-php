...
class ExtensionTypeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public function xmlSerialize(\Sabre\Xml\Writer $writer)
    {
        ...
        $value = $this->getId();
        if (null !== $value) {
            $writer->writeElement("{http://www.ebay.com/marketplace/search/v1/services}id", $value);
        }
        ...
        if (null !== $value) {
            $writer->writeElement("{http://www.ebay.com/marketplace/search/v1/services}contentType", $value);
        }
        $value = $this->getValue();
        if (null !== $value) {
