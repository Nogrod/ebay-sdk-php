...
/**
 * Class representing FindCompletedItemsResponseType
 *
 * Response container for the findCompletedItems call.
 * XSD Type: FindCompletedItemsResponse
 */
class FindCompletedItemsResponseType extends BaseFindingServiceResponseType
{
    /**
