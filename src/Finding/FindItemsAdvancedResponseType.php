...
/**
 * Class representing FindItemsAdvancedResponseType
 *
 * Response container for the findItemsAdvanced call.
 * XSD Type: FindItemsAdvancedResponse
 */
class FindItemsAdvancedResponseType extends BaseFindingServiceResponseType
{
    /**
