...
class CrossPromotionsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\PromotedItemType[] $promotedItem
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\PromotedItemType $promotedItem
     */
    public function addToPromotedItem(\Nogrod\eBaySDK\Trading\PromotedItemType $promotedItem)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\PromotedItemType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PrimaryScheme');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShippingDiscount');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PromotedItem', true);
