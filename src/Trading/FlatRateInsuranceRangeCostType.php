...
class FlatRateInsuranceRangeCostType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $insuranceCost
     */
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $insuranceCost
     * @return self
     */
    public function setInsuranceCost(\Nogrod\eBaySDK\Trading\AmountType $insuranceCost)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setInsuranceCost(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
    }
}
