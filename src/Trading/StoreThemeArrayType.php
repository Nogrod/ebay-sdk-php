...
class StoreThemeArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\StoreColorSchemeType[] $genericColorSchemeArray
     */
     ...
     */
    public function addToTheme(\Nogrod\eBaySDK\Trading\StoreThemeType $theme)
    {
        $this->theme[] = $theme;
        return $this;
    }
     ...
     */
    public function addToGenericColorSchemeArray(\Nogrod\eBaySDK\Trading\StoreColorSchemeType $colorScheme)
    {
     ...
     *  themes are also known as advanced themes).
     *
     * @param \Nogrod\eBaySDK\Trading\StoreColorSchemeType[] $genericColorSchemeArray
     * @return self
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Theme', true);
        if (null !== $value && !empty($value)) {
            $this->setTheme(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\StoreThemeType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}GenericColorSchemeArray', true);
        if (null !== $value && !empty($value)) {
            $this->setGenericColorSchemeArray(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\StoreColorSchemeType::fromKeyValue($v);
            }, $value));
        }
    }
