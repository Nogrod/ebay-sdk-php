...
/**
 * Class representing BestOfferEnabledDefinitionType
 *
 ...
 * XSD Type: BestOfferEnabledDefinitionType
 */
class BestOfferEnabledDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\BestOfferEnabledDefinitionType
    {
        $self = new self();
