...
class SellerPaymentType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $shippingReimbursement
     */
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $commission
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $shippingReimbursement
     * @return self
     */
    public function setShippingReimbursement(\Nogrod\eBaySDK\Trading\AmountType $shippingReimbursement)
    {
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $commission
     * @return self
     */
    public function setCommission(\Nogrod\eBaySDK\Trading\AmountType $commission)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PaymentType');
        if (null !== $value) {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShippingReimbursement');
        if (null !== $value) {
            $this->setShippingReimbursement(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Commission');
        if (null !== $value) {
            $this->setCommission(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
