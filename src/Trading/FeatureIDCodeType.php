...
class FeatureIDCodeType
{
     ...
     *
     * The feature associated with this value is deprecated, so specifying this value
     * as a <b>FeatureID</b> value has no practical use.
     */
     ...
     *
     * The Featured Gallery feature is deprecated, so specifying this value as a
     * <b>FeatureID</b> value has no practical use.
     */
     ...
     *  Sellers have the option of using the same return policy settings for both
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported returns accepted options for
     * international returns, the <b>InternationalReturnsAcceptedValues</b> enum should
     * be used.
     *  </span>
     */
     ...
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported returns accepted options for
     * domestic returns, the <b>DomesticReturnsAcceptedValues</b> enum should be used.
     *  </span>
     */
     ...
     *  Sellers have the option of using the same return policy settings for both
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported return windows for
     * international returns, the <b>InternationalReturnsDurationValues</b> enum should
     * be used.
     *  </span>
     */
     ...
     *  Sellers have the option of using the same return policy settings for both
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported return windows for domestic
     * returns, the <b>DomesticReturnsDurationValues</b> enum should be used.
     *  </span>
     */
     ...
     *  Sellers have the option of using the same return policy settings for both
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported return shipment payee values
     * for international returns, the <b>InternationalReturnsShipmentPayeeValues</b>
     * enum should be used.
     *  </span>
     */
     ...
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported return shipment payee values
     * for domestic returns, the <b>DomesticReturnsShipmentPayeeValues</b> enum should
     * be used.
     *  </span>
     */
     ...
     *  Sellers have the option of using the same return policy settings for both
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported refund method options for
     * international returns, the <b>InternationalRefundMethodValues</b> enum should be
     * used.
     *  </span>
     */
     ...
     * domestic and international returns, or different settings for domestic and
     * international return policies. To see the supported refund method options for
     * domestic returns, the <b>DomesticRefundMethodValues</b> enum should be used.
     *  </span>
     */
