...
/**
 * Class representing SetMessagePreferencesResponseType
 *
 ...
 * XSD Type: SetMessagePreferencesResponseType
 */
class SetMessagePreferencesResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\SetMessagePreferencesResponseType
    {
        $self = new self();
