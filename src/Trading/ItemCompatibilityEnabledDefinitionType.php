...
/**
 * Class representing ItemCompatibilityEnabledDefinitionType
 *
 ...
 *  attributes.</li>
 *  </ul>
 * XSD Type: ItemCompatibilityEnabledDefinitionType
 */
class ItemCompatibilityEnabledDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\ItemCompatibilityEnabledDefinitionType
    {
        $self = new self();
