...
class ReturnPolicyDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\WarrantyOfferedDetailsType $warrantyOffered
     */
    public function addToWarrantyOffered(\Nogrod\eBaySDK\Trading\WarrantyOfferedDetailsType $warrantyOffered)
    {
     ...
     * This field is no longer applicable, as sellers are no longer allowed to offer any type of warranty through a listings's return policy.
     *
     * @return \Nogrod\eBaySDK\Trading\WarrantyOfferedDetailsType[]
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\WarrantyTypeDetailsType $warrantyType
     */
    public function addToWarrantyType(\Nogrod\eBaySDK\Trading\WarrantyTypeDetailsType $warrantyType)
    {
     ...
     * This field is no longer applicable, as sellers are no longer allowed to offer any type of warranty through a listings's return policy.
     *
     * @return \Nogrod\eBaySDK\Trading\WarrantyTypeDetailsType[]
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\WarrantyDurationDetailsType $warrantyDuration
     */
    public function addToWarrantyDuration(\Nogrod\eBaySDK\Trading\WarrantyDurationDetailsType $warrantyDuration)
    {
     ...
     * This field is no longer applicable, as sellers are no longer allowed to offer any type of warranty through a listings's return policy.
     *
     * @return \Nogrod\eBaySDK\Trading\WarrantyDurationDetailsType[]
     */
