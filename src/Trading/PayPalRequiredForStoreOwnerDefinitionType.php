 ...
 *  <br><br>
 *  <span class="tablenote"><b>Note: </b> Although the <b>PayPalRequiredForStoreOwner</b> field is still being returned for now, sellers never need to set the available electronic payments, and PayPal will never be required on any eBay marketplace.
 *  </span>
