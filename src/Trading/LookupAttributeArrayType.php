...
class LookupAttributeArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\LookupAttributeType[] $lookupAttribute
     */
     ...
     */
    public function addToLookupAttribute(\Nogrod\eBaySDK\Trading\LookupAttributeType $lookupAttribute)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setLookupAttribute(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\LookupAttributeType::fromKeyValue($v);}, $value));
        }
    }
}
