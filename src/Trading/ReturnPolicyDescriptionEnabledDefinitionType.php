...
/**
 * Class representing ReturnPolicyDescriptionEnabledDefinitionType
 *
 ...
 * XSD Type: ReturnPolicyDescriptionEnabledDefinitionType
 */
class ReturnPolicyDescriptionEnabledDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\ReturnPolicyDescriptionEnabledDefinitionType
    {
        $self = new self();
