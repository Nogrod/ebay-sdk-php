...
/**
 * Class representing InternationalReturnsAcceptedDefinitionType
 *
 ...
 * XSD Type: InternationalReturnsAcceptedDefinitionType
 */
class InternationalReturnsAcceptedDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\InternationalReturnsAcceptedDefinitionType
    {
        $self = new self();
