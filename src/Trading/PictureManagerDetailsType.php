...
class PictureManagerDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\PictureManagerFolderType $folder
     */
    public function addToFolder(\Nogrod\eBaySDK\Trading\PictureManagerFolderType $folder)
    {
        $this->folder[] = $folder;
        return $this;
    }
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\PictureManagerFolderType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setFolder(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\PictureManagerFolderType::fromKeyValue($v);}, $value));
        }
    }
}
