...
class ItemsCanceledEventType extends AbstractResponseType
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CanceledItemIDArray', true);
        if (null !== $value && !empty($value)) {
            $this->setCanceledItemIDArray($value);
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}EligibleForRelist');
        if (null !== $value) {
