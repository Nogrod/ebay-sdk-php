...
class CharacteristicsSetProductHistogramType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\HistogramEntryType $histogramEntry
     */
    public function addToHistogramEntry(\Nogrod\eBaySDK\Trading\HistogramEntryType $histogramEntry)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\HistogramEntryType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}HistogramEntry', true);
        if (null !== $value && !empty($value)) {
            $this->setHistogramEntry(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\HistogramEntryType::fromKeyValue($v);
            }, $value));
        }
    }
