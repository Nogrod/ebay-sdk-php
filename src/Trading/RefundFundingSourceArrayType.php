...
class RefundFundingSourceArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     */
    public function addToRefundFundingSource(\Nogrod\eBaySDK\Trading\RefundFundingSourceType $refundFundingSource)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setRefundFundingSource(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\RefundFundingSourceType::fromKeyValue($v);}, $value));
        }
    }
}
