...
class GetMyeBayRemindersRequestType extends AbstractRequestType
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BuyingReminders');
        if (null !== $value) {
            $this->setBuyingReminders(\Nogrod\eBaySDK\Trading\ReminderCustomizationType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellingReminders');
        if (null !== $value) {
