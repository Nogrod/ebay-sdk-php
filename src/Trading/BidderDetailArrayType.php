...
class BidderDetailArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\BidderDetailType $bidderDetail
     */
    public function addToBidderDetail(\Nogrod\eBaySDK\Trading\BidderDetailType $bidderDetail)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\BidderDetailType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}BidderDetail', true);
