...
class ActiveInventoryReportResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\ActiveInventoryReportResponseType
    {
        $self = new self();
    ...
    public function setKeyValue($keyValue): void
    {
        ...
        if (null !== $value) {
            $this->setSKUDetails(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\SKUDetailsType::fromKeyValue($v);
            }, $value));
        }
    }
}
