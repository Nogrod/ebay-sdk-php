...
/**
 * Class representing SetUserPreferencesResponseType
 *
 ...
 * XSD Type: SetUserPreferencesResponseType
 */
class SetUserPreferencesResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\SetUserPreferencesResponseType
    {
        $self = new self();
