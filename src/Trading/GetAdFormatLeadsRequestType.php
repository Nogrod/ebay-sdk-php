...
class GetAdFormatLeadsRequestType extends AbstractRequestType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\GetAdFormatLeadsRequestType
    {
        $self = new self();
    ...
    public function setKeyValue($keyValue): void
    {
        ...
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}IncludeMemberMessages');
        if (null !== $value) {
