...
class ItemRatingDetailArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\ItemRatingDetailArrayType
    {
        $self = new self();
    ...
    {
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ItemRatingDetails');
        if (null !== $value) {
            $this->setItemRatingDetails(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\ItemRatingDetailsType::fromKeyValue($v);}, $value));
        }
    }
}
