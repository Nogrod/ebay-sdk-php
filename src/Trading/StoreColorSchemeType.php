...
class StoreColorSchemeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * Store color set.
     *
     * @var \Nogrod\eBaySDK\Trading\StoreColorType $color
     */
    private $color = null;
     ...
     *  schemes.
     *
     * @var \Nogrod\eBaySDK\Trading\StoreFontType $font
     */
    private $font = null;
     ...
     * Store color set.
     *
     * @return \Nogrod\eBaySDK\Trading\StoreColorType
     */
     ...
     * Store color set.
     *
     * @param \Nogrod\eBaySDK\Trading\StoreColorType $color
     * @return self
     */
    public function setColor(\Nogrod\eBaySDK\Trading\StoreColorType $color)
    {
        $this->color = $color;
        return $this;
    }
     ...
     *  schemes.
     *
     * @return \Nogrod\eBaySDK\Trading\StoreFontType
     */
     ...
     *  schemes.
     *
     * @param \Nogrod\eBaySDK\Trading\StoreFontType $font
     * @return self
     */
    public function setFont(\Nogrod\eBaySDK\Trading\StoreFontType $font)
    {
        $this->font = $font;
        return $this;
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setColor(\Nogrod\eBaySDK\Trading\StoreColorType::fromKeyValue($value));
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Font');
        if (null !== $value) {
            $this->setFont(\Nogrod\eBaySDK\Trading\StoreFontType::fromKeyValue($value));
        }
    }
}
