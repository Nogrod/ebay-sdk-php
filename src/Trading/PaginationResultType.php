...
class PaginationResultType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TotalNumberOfPages');
        if (null !== $value) {
            $this->setTotalNumberOfPages($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TotalNumberOfEntries');
        if (null !== $value) {
