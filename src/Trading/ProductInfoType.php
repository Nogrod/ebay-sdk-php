...
class ProductInfoType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $averageStartPrice
     */
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $averageSoldPrice
     */
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $averageStartPrice
     * @return self
     */
    public function setAverageStartPrice(\Nogrod\eBaySDK\Trading\AmountType $averageStartPrice)
    {
     ...
     * This field is deprecated.
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $averageSoldPrice
     * @return self
     */
    public function setAverageSoldPrice(\Nogrod\eBaySDK\Trading\AmountType $averageSoldPrice)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AverageStartPrice');
        if (null !== $value) {
            $this->setAverageStartPrice(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AverageSoldPrice');
        if (null !== $value) {
            $this->setAverageSoldPrice(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Title');
        if (null !== $value) {
            $this->setTitle($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ProductState');
        if (null !== $value) {
