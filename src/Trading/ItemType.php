...
class ItemType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\ListingDesignerType $listingDesigner
     */
     ...
     * Contains the detail data for the Listing Designer theme and template (if either are used), which can optionally be used to enhance the appearance of the description area of an item's description.
     *
     * @return \Nogrod\eBaySDK\Trading\ListingDesignerType
     */
     ...
     * Contains the detail data for the Listing Designer theme and template (if either are used), which can optionally be used to enhance the appearance of the description area of an item's description.
     *
     * @param \Nogrod\eBaySDK\Trading\ListingDesignerType $listingDesigner
     * @return self
     */
    public function setListingDesigner(\Nogrod\eBaySDK\Trading\ListingDesignerType $listingDesigner)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ListingDesigner');
        if (null !== $value) {
            $this->setListingDesigner(\Nogrod\eBaySDK\Trading\ListingDesignerType::fromKeyValue($value));
        }
