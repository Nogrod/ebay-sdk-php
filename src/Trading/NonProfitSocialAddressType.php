...
class NonProfitSocialAddressType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SocialAddressType');
        if (null !== $value) {
            $this->setSocialAddressType($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SocialAddressId');
        if (null !== $value) {
