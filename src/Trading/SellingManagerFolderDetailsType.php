...
class SellingManagerFolderDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\SellingManagerFolderDetailsType[] $childFolder
     */
    private $childFolder = [
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\SellingManagerFolderDetailsType $childFolder
     */
    public function addToChildFolder(\Nogrod\eBaySDK\Trading\SellingManagerFolderDetailsType $childFolder)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FolderLevel');
        if (null !== $value) {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}FolderComment');
        if (null !== $value) {
            $this->setFolderComment($value);
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ChildFolder', true);
        if (null !== $value && !empty($value)) {
            $this->setChildFolder(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\SellingManagerFolderDetailsType::fromKeyValue($v);
            }, $value));
        }
