...
class GetUserPreferencesResponseType extends AbstractResponseType
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerExcludeShipToLocationPreferences', true);
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerProfilePreferences');
        if (null !== $value) {
            $this->setSellerProfilePreferences(\Nogrod\eBaySDK\Trading\SellerProfilePreferencesType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SellerReturnPreferences');
        if (null !== $value) {
            $this->setSellerReturnPreferences(\Nogrod\eBaySDK\Trading\SellerReturnPreferencesType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}OfferGlobalShippingProgramPreference');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}OverrideGSPServiceWithIntlServicePreference');
        if (null !== $value) {
            $this->setOverrideGSPServiceWithIntlServicePreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}PickupDropoffSellerPreference');
        if (null !== $value) {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}eBayPLUSPreference', true);
        if (null !== $value && !empty($value)) {
