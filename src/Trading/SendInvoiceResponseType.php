...
/**
 * Class representing SendInvoiceResponseType
 *
 ...
 * XSD Type: SendInvoiceResponseType
 */
class SendInvoiceResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\SendInvoiceResponseType
    {
        $self = new self();
