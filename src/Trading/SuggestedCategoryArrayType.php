...
class SuggestedCategoryArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\SuggestedCategoryType[] $suggestedCategory
     */
     ...
     */
    public function addToSuggestedCategory(\Nogrod\eBaySDK\Trading\SuggestedCategoryType $suggestedCategory)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SuggestedCategory', true);
