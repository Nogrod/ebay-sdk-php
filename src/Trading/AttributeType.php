...
class AttributeType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\ValType $value
     */
    public function addToValue(\Nogrod\eBaySDK\Trading\ValType $value)
    {
        $this->value[] = $value;
        return $this;
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setValue(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\ValType::fromKeyValue($v);}, $value));
        }
    }
}
