...
class GetVeROReportStatusResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\GetVeROReportStatusResponseType
    {
        $self = new self();
    ...
    public function setKeyValue($keyValue): void
    {
        ...
        if (null !== $value) {
            $this->setReportedItemDetails(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\VeROReportedItemType::fromKeyValue(Func::mapObject($v, '{urn:ebay:apis:eBLBaseComponents}ReportedItem'));
            }, $value));
        }
    }
}
