...
class BidApprovalType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    /**
     * @var \Nogrod\eBaySDK\Trading\AmountType $approvedBiddingLimit
     */
     ...
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $approvedBiddingLimit
     * @return self
     */
    public function setApprovedBiddingLimit(\Nogrod\eBaySDK\Trading\AmountType $approvedBiddingLimit)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ApprovedBiddingLimit');
        if (null !== $value) {
            $this->setApprovedBiddingLimit(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}DeclinedComment');
        if (null !== $value) {
