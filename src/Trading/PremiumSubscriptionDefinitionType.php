...
/**
 * Class representing PremiumSubscriptionDefinitionType
 *
 ...
 *  national listing.
 * XSD Type: PremiumSubscriptionDefinitionType
 */
class PremiumSubscriptionDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\PremiumSubscriptionDefinitionType
    {
        $self = new self();
