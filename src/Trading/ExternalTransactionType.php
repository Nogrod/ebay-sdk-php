...
class ExternalTransactionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *  </span>
     *
     * @var \Nogrod\eBaySDK\Trading\AmountType $paymentOrRefundAmount
     */
     ...
     *  </span>
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $paymentOrRefundAmount
     * @return self
     */
    public function setPaymentOrRefundAmount(\Nogrod\eBaySDK\Trading\AmountType $paymentOrRefundAmount)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setPaymentOrRefundAmount(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
