...
/**
 * Class representing BestOfferAutoDeclineEnabledDefinitionType
 *
 ...
 * XSD Type: BestOfferAutoDeclineEnabledDefinitionType
 */
class BestOfferAutoDeclineEnabledDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\BestOfferAutoDeclineEnabledDefinitionType
    {
        $self = new self();
