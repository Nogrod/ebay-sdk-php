...
class ItemTotalsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    /**
     * @var \Nogrod\eBaySDK\Trading\AmountType $totalValue
     */
     ...
     *
     * @param \Nogrod\eBaySDK\Trading\AmountType $totalValue
     * @return self
     */
    public function setTotalValue(\Nogrod\eBaySDK\Trading\AmountType $totalValue)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value) {
            $this->setTotalValue(\Nogrod\eBaySDK\Trading\AmountType::fromKeyValue($value));
        }
    }
}
