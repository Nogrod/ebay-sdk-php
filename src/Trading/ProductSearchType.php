...
class ProductSearchType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\SearchAttributesType[] $searchAttributes
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\SearchAttributesType $searchAttributes
     */
    public function addToSearchAttributes(\Nogrod\eBaySDK\Trading\SearchAttributesType $searchAttributes)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\SearchAttributesType[]
     */
    ...
    {
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ProductSearchID');
        if (null !== $value) {
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SortAttributeID');
        if (null !== $value) {
            $this->setSortAttributeID($value);
        }
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}MaxChildrenPerFamily');
        if (null !== $value) {
        ...
        if (null !== $value && !empty($value)) {
            $this->setSearchAttributes(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\SearchAttributesType::fromKeyValue($v);}, $value));
        }
        ...
        $value = Func::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CharacteristicSetIDs', true);
        if (null !== $value && !empty($value)) {
