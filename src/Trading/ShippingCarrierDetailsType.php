...
class ShippingCarrierDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\ShippingCarrierDetailsType
    {
        $self = new self();
    ...
    {
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShippingCarrierID');
        if (null !== $value) {
