...
/**
 * Class representing RevokeTokenResponseType
 *
 ...
 * XSD Type: RevokeTokenResponseType
 */
class RevokeTokenResponseType extends AbstractResponseType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\RevokeTokenResponseType
    {
        $self = new self();
