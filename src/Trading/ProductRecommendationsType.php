...
class ProductRecommendationsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\ProductInfoType[] $product
     */
    private $product = [
     ...
     */
    public function addToProduct(\Nogrod\eBaySDK\Trading\ProductInfoType $product)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setProduct(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\ProductInfoType::fromKeyValue($v);}, $value));
        }
    }
}
