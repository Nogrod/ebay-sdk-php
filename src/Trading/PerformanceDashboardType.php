...
class PerformanceDashboardType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * @return self
     */
    public function setAlert(\Nogrod\eBaySDK\Trading\SellerDashboardAlertType $alert)
    {
        $this->alert = $alert;
        return $this;
    }
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Site', true);
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Alert');
        if (null !== $value) {
            $this->setAlert(\Nogrod\eBaySDK\Trading\SellerDashboardAlertType::fromKeyValue($value));
        }
    }
