...
class CharitySellerType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\CharityAffiliationType $charityAffiliation
     */
    public function addToCharityAffiliation(\Nogrod\eBaySDK\Trading\CharityAffiliationType $charityAffiliation)
    {
     ...
     * Indicates the affiliation status for nonprofit charity organizations registered with the PayPal Giving Fund.
     *
     * @return \Nogrod\eBaySDK\Trading\CharityAffiliationType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CharitySellerStatus');
        if (null !== $value) {
            $this->setCharitySellerStatus($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}CharityAffiliation', true);
        if (null !== $value && !empty($value)) {
            $this->setCharityAffiliation(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\CharityAffiliationType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}TermsAndConditionsAccepted');
        if (null !== $value) {
