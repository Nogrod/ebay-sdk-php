...
class GetOrdersRequestType extends AbstractRequestType
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\GetOrdersRequestType
    {
        $self = new self();
    ...
    public function setKeyValue($keyValue): void
    {
        ...
        if (null !== $value) {
            $this->setOrderIDArray(array_map(function ($v) {
                return Func::mapValue($v, '{urn:ebay:apis:eBLBaseComponents}OrderID');
            }, $value));
        }
        ...
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}CreateTimeTo');
        if (null !== $value) {
            $this->setCreateTimeTo(new \DateTime($value));
        }
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}OrderRole');
        if (null !== $value) {
        ...
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}SortingOrder');
        if (null !== $value) {
