...
class PromotionRuleArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\PromotionRuleType $promotionRule
     */
    public function addToPromotionRule(\Nogrod\eBaySDK\Trading\PromotionRuleType $promotionRule)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\PromotionRuleType[]
     */
    ...
    public function xmlSerialize(\Sabre\Xml\Writer $writer): void
    {
        ...
        if (null !== $value && !empty($this->getPromotionRule())) {
            $writer->write(array_map(function ($v) {return ["PromotionRule" => $v];}, $value));
        }
    }
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setPromotionRule(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\PromotionRuleType::fromKeyValue($v);}, $value));
        }
    }
}
