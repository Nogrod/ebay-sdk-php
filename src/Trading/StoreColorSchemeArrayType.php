...
class StoreColorSchemeArrayType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     */
    public function addToColorScheme(\Nogrod\eBaySDK\Trading\StoreColorSchemeType $colorScheme)
    {
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ColorScheme', true);
