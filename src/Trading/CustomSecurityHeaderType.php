...
class CustomSecurityHeaderType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\UserIdPasswordType $credentials
     */
     ...
     *  username and password instead.
     *
     * @return \Nogrod\eBaySDK\Trading\UserIdPasswordType
     */
     ...
     *  username and password instead.
     *
     * @param \Nogrod\eBaySDK\Trading\UserIdPasswordType $credentials
     * @return self
     */
    public function setCredentials(\Nogrod\eBaySDK\Trading\UserIdPasswordType $credentials)
    {
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}Credentials');
        if (null !== $value) {
            $this->setCredentials(\Nogrod\eBaySDK\Trading\UserIdPasswordType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}NotificationSignature');
        if (null !== $value) {
