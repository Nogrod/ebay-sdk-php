...
/**
 * Class representing EANEnabledDefinitionType
 *
 ...
 * XSD Type: EANEnabledDefinitionType
 */
class EANEnabledDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\EANEnabledDefinitionType
    {
        $self = new self();
