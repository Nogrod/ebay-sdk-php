...
class StoreCustomListingHeaderType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\StoreCustomListingHeaderLinkType[] $linkToInclude
     */
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\StoreCustomListingHeaderLinkType $linkToInclude
     */
    public function addToLinkToInclude(\Nogrod\eBaySDK\Trading\StoreCustomListingHeaderLinkType $linkToInclude)
    {
     ...
     * Link to include in the custom header.
     *
     * @return \Nogrod\eBaySDK\Trading\StoreCustomListingHeaderLinkType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setLinkToInclude(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\StoreCustomListingHeaderLinkType::fromKeyValue($v);
            }, $value));
        }
