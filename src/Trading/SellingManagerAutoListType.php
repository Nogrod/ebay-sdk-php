...
class SellingManagerAutoListType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\SellingManagerAutoListMinActiveItemsType $keepMinActive
     */
     ...
     *
     * @var \Nogrod\eBaySDK\Trading\SellingManagerAutoListAccordingToScheduleType $listAccordingToSchedule
     */
     ...
     * Specifies an automated listing rule that keeps a minimum number of listings on the site.
     *
     * @return \Nogrod\eBaySDK\Trading\SellingManagerAutoListMinActiveItemsType
     */
     ...
     * Specifies an automated listing rule that keeps a minimum number of listings on the site.
     *
     * @param \Nogrod\eBaySDK\Trading\SellingManagerAutoListMinActiveItemsType $keepMinActive
     * @return self
     */
    public function setKeepMinActive(\Nogrod\eBaySDK\Trading\SellingManagerAutoListMinActiveItemsType $keepMinActive)
    {
     ...
     * Specifies an automated listing rule that lists items according to a specified schedule.
     *
     * @return \Nogrod\eBaySDK\Trading\SellingManagerAutoListAccordingToScheduleType
     */
     ...
     * Specifies an automated listing rule that lists items according to a specified schedule.
     *
     * @param \Nogrod\eBaySDK\Trading\SellingManagerAutoListAccordingToScheduleType $listAccordingToSchedule
     * @return self
     */
    public function setListAccordingToSchedule(\Nogrod\eBaySDK\Trading\SellingManagerAutoListAccordingToScheduleType $listAccordingToSchedule)
    {
