...
class GetAdFormatLeadsResponseType extends AbstractResponseType
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AdFormatLead', true);
        if (null !== $value && !empty($value)) {
            $this->setAdFormatLead(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\AdFormatLeadType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}AdFormatLeadCount');
        if (null !== $value) {
