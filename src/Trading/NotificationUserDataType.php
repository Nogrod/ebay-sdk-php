...
class NotificationUserDataType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * @return self
     */
    public function setSMSSubscription(\Nogrod\eBaySDK\Trading\SMSSubscriptionType $sMSSubscription)
    {
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\SummaryEventScheduleType $summarySchedule
     */
    public function addToSummarySchedule(\Nogrod\eBaySDK\Trading\SummaryEventScheduleType $summarySchedule)
    {
     ...
     *  "Informational Alerts".
     *
     * @return \Nogrod\eBaySDK\Trading\SummaryEventScheduleType[]
     */
    ...
    {
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SMSSubscription');
        if (null !== $value) {
            $this->setSMSSubscription(\Nogrod\eBaySDK\Trading\SMSSubscriptionType::fromKeyValue($value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}SummarySchedule', true);
        if (null !== $value && !empty($value)) {
            $this->setSummarySchedule(array_map(function ($v) {
                return \Nogrod\eBaySDK\Trading\SummaryEventScheduleType::fromKeyValue($v);
            }, $value));
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ExternalUserData');
        if (null !== $value) {
