...
class GetUserPreferencesRequestType extends AbstractRequestType
{
    ...
    public function setKeyValue($keyValue)
    {
        ...
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowBidderNoticePreferences');
        if (null !== $value) {
            $this->setShowBidderNoticePreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowCombinedPaymentPreferences');
        if (null !== $value) {
            $this->setShowCombinedPaymentPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowCrossPromotionPreferences');
        if (null !== $value) {
            $this->setShowCrossPromotionPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowSellerPaymentPreferences');
        if (null !== $value) {
            $this->setShowSellerPaymentPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowEndOfAuctionEmailPreferences');
        if (null !== $value) {
            $this->setShowEndOfAuctionEmailPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowSellerFavoriteItemPreferences');
        if (null !== $value) {
            $this->setShowSellerFavoriteItemPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowProStoresPreferences');
        if (null !== $value) {
            $this->setShowProStoresPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowEmailShipmentTrackingNumberPreference');
        if (null !== $value) {
            $this->setShowEmailShipmentTrackingNumberPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowRequiredShipPhoneNumberPreference');
        if (null !== $value) {
            $this->setShowRequiredShipPhoneNumberPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowSellerExcludeShipToLocationPreference');
        if (null !== $value) {
            $this->setShowSellerExcludeShipToLocationPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowUnpaidItemAssistancePreference');
        if (null !== $value) {
            $this->setShowUnpaidItemAssistancePreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowPurchaseReminderEmailPreferences');
        if (null !== $value) {
            $this->setShowPurchaseReminderEmailPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowUnpaidItemAssistanceExclusionList');
        if (null !== $value) {
            $this->setShowUnpaidItemAssistanceExclusionList($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowSellerProfilePreferences');
        if (null !== $value) {
            $this->setShowSellerProfilePreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowSellerReturnPreferences');
        if (null !== $value) {
            $this->setShowSellerReturnPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowGlobalShippingProgramPreference');
        if (null !== $value) {
            $this->setShowGlobalShippingProgramPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowDispatchCutoffTimePreferences');
        if (null !== $value) {
            $this->setShowDispatchCutoffTimePreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowGlobalShippingProgramListingPreference');
        if (null !== $value) {
            $this->setShowGlobalShippingProgramListingPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowOverrideGSPServiceWithIntlServicePreference');
        if (null !== $value) {
            $this->setShowOverrideGSPServiceWithIntlServicePreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowPickupDropoffPreferences');
        if (null !== $value) {
            $this->setShowPickupDropoffPreferences($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShowOutOfStockControlPreference');
        if (null !== $value) {
            $this->setShowOutOfStockControlPreference($value);
        }
        $value = self::mapArray($keyValue, '{urn:ebay:apis:eBLBaseComponents}ShoweBayPLUSPreference');
        if (null !== $value) {
