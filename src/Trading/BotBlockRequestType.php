...
class BotBlockRequestType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\BotBlockRequestType
    {
        $self = new self();
    ...
    public function setKeyValue($keyValue): void
    {
        ...
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}BotBlockUserInput');
        if (null !== $value) {
