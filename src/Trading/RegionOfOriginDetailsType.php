...
class RegionOfOriginDetailsType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\RegionOfOriginDetailsType
    {
        $self = new self();
    ...
    {
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}RegionOfOrigin');
        if (null !== $value) {
