...
class FeedbackPeriodType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\FeedbackPeriodType
    {
        $self = new self();
    ...
    {
        $value = Func::mapValue($keyValue, '{urn:ebay:apis:eBLBaseComponents}PeriodInDays');
        if (null !== $value) {
