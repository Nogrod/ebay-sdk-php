...
class PictureManagerFolderType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
     ...
     * This field is deprecated.
     *
     * @var \Nogrod\eBaySDK\Trading\PictureManagerPictureType[] $picture
     */
    private $picture = [
     ...
     *
     * @return self
     * @param \Nogrod\eBaySDK\Trading\PictureManagerPictureType $picture
     */
    public function addToPicture(\Nogrod\eBaySDK\Trading\PictureManagerPictureType $picture)
    {
     ...
     * This field is deprecated.
     *
     * @return \Nogrod\eBaySDK\Trading\PictureManagerPictureType[]
     */
    ...
    public function setKeyValue($keyValue)
    {
        ...
        if (null !== $value && !empty($value)) {
            $this->setPicture(array_map(function ($v) {return \Nogrod\eBaySDK\Trading\PictureManagerPictureType::fromKeyValue($v);}, $value));
        }
    }
}
