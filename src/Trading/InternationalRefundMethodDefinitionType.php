...
/**
 * Class representing InternationalRefundMethodDefinitionType
 *
 ...
 * XSD Type: InternationalRefundMethodDefinitionType
 */
class InternationalRefundMethodDefinitionType implements \Sabre\Xml\XmlSerializable, \Sabre\Xml\XmlDeserializable
{
    ...
    public static function fromKeyValue($keyValue): \Nogrod\eBaySDK\Trading\InternationalRefundMethodDefinitionType
    {
        $self = new self();
